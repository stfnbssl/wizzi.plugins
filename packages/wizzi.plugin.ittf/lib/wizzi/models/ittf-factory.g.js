...
md.createLoadModel = function(wizziObject) {
    ...
    function loadModelFromMTree(mTree, ittfDocumentUri, wizziModelRequest, options, callback) {
        // loog 'wizzi-core.wizzi.models.ittf-factory.g, loaded from mTree'
    ...
    */
        ...
        return function loadModel(ittfDocumentUri, requestContext, callback) {
                ...
                loadMTree(ittfDocumentUri, requestContext, function(err, mTree) {
                    ...
                    // loog 'Loaded mTree instance for pseudo schema ittf from Ittf document ' + ittfDocumentUri + ' in ' + (Date.now() - start) + ' ms'
                    ...
                    // loog 'wizzi-core.wizzi.models.ittf-factory.g current __dirname', __dirname
                    // loog 'wizzi-core.wizzi.models.ittf-factory.g, loaded from ittfDocumentUri: ', ittfDocumentUri, mTree
                    ittfmodel(mTree, ittfDocumentUri, wizziModelRequest, callback);
                })
            };
    }
...
function error(code, method, message, innerError) {
    ...
    return verify.error(innerError, {
        ...
        method: 'wizzi.plugi.ittf.lib.wizzi.models.ittf-factory.g.' + method,
        parameter: parameter,
