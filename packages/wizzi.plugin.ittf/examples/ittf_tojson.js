/*
    ...
    package: wizzi-js@
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.plugins\packages\wizzi.plugin.ittf\.wizzi-override\examples\ittf_tojson.js.ittf
...
function executeExample() {
    ...
    function executeGenerateModules(modules, callback) {
        async.mapSeries(modules, (module, callback) => {
            ...
            var outputPath = path.join(__dirname, 'results', 'ittf', module + '-tojson.json');
            loadModelAndGenerateArtifact(ittfDocumentUri, {}, 'ittf/tojson', (err, artifactText) => {
