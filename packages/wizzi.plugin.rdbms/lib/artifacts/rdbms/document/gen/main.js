/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.plugins\packages\wizzi.plugin.rdbms\.wizzi-override\lib\artifacts\rdbms\document\gen\main.js.ittf
*/
'use strict';
...
var myname = 'wizzi.plugin.rdbms.artifacts.rdbms.document.gen.main';
...
md.gen = function(model, ctx, callback) {
    ...
    if (model.wzElement !== 'rdbms') {
        callback(error('InvalidArgument', 'gen', 'Invalid model schema. Expected root element "rdbms". Received: ' + model.wzElement, model))
    }
    try {
        md.rdbms(model, ctx, (err, notUsed) => {
...
;
md.rdbms = function(model, ctx, callback) {
    ctx.w('<rdbms>');
...
function error(errorName, method, message, model, innerError) {
    return new errors.WizziPluginError(message, model, {
            errorName: errorName, 
            method: 'wizzi.plugin.rdbms/lib/artifacts/rdbms/document/gen/main.' + method, 
