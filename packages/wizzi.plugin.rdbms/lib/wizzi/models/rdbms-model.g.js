...
var rdbms = (function (rdbmsBase) {
    ...
    rdbms.prototype.toXmlProperties = function(xw) {
        _md.rdbmsBase.prototype.toXmlProperties.call(this, xw);
    }
    rdbms.prototype.toXmlChildren = function(xw) {
        _md.rdbmsBase.prototype.toXmlChildren.call(this, xw);
    ...
    rdbms.prototype.testInfo = function() {
        ...
        var i, i_items=this.tables, i_len=this.tables.length, table;
        for (i=0; i<i_len; i++) {
            table = this.tables[i];
            var ctx = {};
            table.testInfo(ctx);
...
var table = (function (rdbmsitem) {
    ...
    table.prototype.toXmlProperties = function(xw) {
        _md.rdbmsitem.prototype.toXmlProperties.call(this, xw);
    ...
    table.prototype.toXmlChildren = function(xw) {
        _md.rdbmsitem.prototype.toXmlChildren.call(this, xw);
    ...
    table.prototype.keyColumns = function() {
        ...
        if (pk) {
            var memo = [];
            var i, i_items=pk.indexColumns, i_len=pk.indexColumns.length, item;
            for (i=0; i<i_len; i++) {
    ...
    table.prototype.lookUps = function() {
        var memo = [];
        var i, i_items=this.tableColumns, i_len=this.tableColumns.length, item;
        for (i=0; i<i_len; i++) {
            item = this.tableColumns[i];
            var j, j_items=item.lookUps, j_len=item.lookUps.length, l;
            for (j=0; j<j_len; j++) {
                l = item.lookUps[j];
                memo.push(l);
            }
    ...
    table.prototype.oneRelations = function() {
        var memo = [];
        var i, i_items=this.wzParent.relations, i_len=this.wzParent.relations.length, item;
        for (i=0; i<i_len; i++) {
    ...
    table.prototype.oneTables = function() {
        var memo = [];
        var i, i_items=this.oneRelations(), i_len=this.oneRelations().length, item;
        for (i=0; i<i_len; i++) {
    ...
    table.prototype.manyTables = function() {
        var memo = [];
        var i, i_items=this.manyRelations(), i_len=this.manyRelations().length, item;
        for (i=0; i<i_len; i++) {
    ...
    table.prototype.cmbLabel = function() {
        var i, i_items=this.labels, i_len=this.labels.length, item;
        for (i=0; i<i_len; i++) {
            item = this.labels[i];
...
var tableColumn = (function (rdbmsitem) {
    ...
    tableColumn.DOMAIN_STRING = "string";tableColumn.DOMAIN_XBOOLEAN = "boolean";tableColumn.DOMAIN_INTEGER = "integer";tableColumn.DOMAIN_XFLOAT = "float";tableColumn.DOMAIN_DATE = "date";tableColumn.DOMAIN_DOCUMENT = "document";tableColumn.FORMAT_NONE = "none";tableColumn.FORMAT_PASSWORD = "password";tableColumn.FORMAT_DATETIME = "datetime";tableColumn.FORMAT_DATETIME_LOCAL = "datetime-local";tableColumn.FORMAT_DATE = "date";tableColumn.FORMAT_MONTH = "month";tableColumn.FORMAT_TIME = "time";tableColumn.FORMAT_WEEK = "week";tableColumn.FORMAT_NUMBER = "number";tableColumn.FORMAT_EMAIL = "email";tableColumn.FORMAT_URL = "url";tableColumn.FORMAT_SEARCH = "search";tableColumn.FORMAT_TEL = "tel";tableColumn.FORMAT_COLOR = "color";tableColumn.FORMAT_HCHECKBOXES = "hcheckboxes";tableColumn.FORMAT_VCHECKBOXES = "vcheckboxes";// w("public tsi.DataTypes.DataType {attribute.wzId}DataType { get; set; }");
    ...
    tableColumn.prototype.isKey = function() {
        if (this.table.primaryKey()) {
            var i, i_items=this.table.primaryKey().indexColumns, i_len=this.table.primaryKey().indexColumns.length, item;
            for (i=0; i<i_len; i++) {
    ...
    tableColumn.prototype.referenceTable = function() {
        var i, i_items=this.table.oneRelations, i_len=this.table.oneRelations.length, r;
        for (i=0; i<i_len; i++) {
            r = this.table.oneRelations[i];
            var j, j_items=r.relationColumns, j_len=r.relationColumns.length, rc;
            for (j=0; j<j_len; j++) {
...
var index = (function (rdbmsitem) {
    ...
    index.prototype.toJsonChildren = function(result) {
        ...
        var items, item;
        items = [];
        this.indexColumns.forEach((item) => {
            items.push(item.toJson());
        });
    ...
    index.prototype.wzInitialize = function(ctx) {
        ...
        this.table = this.wzParent;
        var i, i_items=this.indexColumns, i_len=this.indexColumns.length, item;
        for (i=0; i<i_len; i++) {
...
var indexColumn = (function (rdbmsitem) {
    ...
    indexColumn.SORT_ASC = "asc";indexColumn.SORT_DESC = "desc";indexColumn.prototype.toJson = function() {
        var result = {};
        this.toJsonProperties(result);
        this.toJsonChildren(result);
        return result;
...
var required = (function (validation) {
    ...
    required.prototype.toXmlProperties = function(xw) {
        _md.validation.prototype.toXmlProperties.call(this, xw);
    }
    required.prototype.toXmlChildren = function(xw) {
        _md.validation.prototype.toXmlChildren.call(this, xw);
    }
    return required;
})(validation);
...
var relation = (function (rdbmsitem) {
    ...
    relation.CARDINALITY_ONE_TO_MANY = "one-to-many";relation.CARDINALITY_ONE_TO_ONE = "one-to-one";relation.ONPARENTINSERT_NONE = "none";relation.ONPARENTINSERT_RESTRICT = "restrict";relation.ONPARENTINSERT_CASCADE = "cascade";relation.ONPARENTUPDATE_NONE = "none";relation.ONPARENTUPDATE_RESTRICT = "restrict";relation.ONPARENTUPDATE_CASCADE = "cascade";relation.ONPARENTDELETE_NONE = "none";relation.ONPARENTDELETE_RESTRICT = "restrict";relation.ONPARENTDELETE_CASCADE = "cascade";relation.ONCHILDINSERT_NONE = "none";relation.ONCHILDINSERT_RESTRICT = "restrict";relation.ONCHILDINSERT_CASCADE = "cascade";relation.ONCHILDUPDATE_NONE = "none";relation.ONCHILDUPDATE_RESTRICT = "restrict";relation.ONCHILDUPDATE_CASCADE = "cascade";relation.ONCHILDDELETE_NONE = "none";relation.ONCHILDDELETE_RESTRICT = "restrict";relation.ONCHILDDELETE_CASCADE = "cascade";relation.prototype.addRelationColumn = function(name, sourceLineInfo) {
    ...
    relation.prototype.oneColumns = function() {
        var memo = [];
        var i, i_items=this.relationColumns, i_len=this.relationColumns.length, item;
        for (i=0; i<i_len; i++) {
    ...
    relation.prototype.oneManyKeys = function() {
        var ret = [], check = {};
        var i, i_items=this.oneTable().keyColumns(), i_len=this.oneTable().keyColumns().length, item;
        for (i=0; i<i_len; i++) {
            item = this.oneTable().keyColumns()[i];
            ret.push(item);
            check[item.wzName] = true;
        }
        var i, i_items=this.manyTable().keyColumns(), i_len=this.manyTable().keyColumns().length, item;
        for (i=0; i<i_len; i++) {
...
var document = (function (rdbmsitem) {
    ...
    document.KIND_JSON_META_DATA = "json-meta-data";document.KIND_ITTF = "ittf";document.KIND_TEXT_CONTENT = "text-content";document.prototype.addPath = function(name, sourceLineInfo) {
...
var path = (function (rdbmsitem) {
    ...
    path.prototype.toJsonChildren = function(result) {
        ...
        var items, item;
        items = [];
        this.pathSegments.forEach((item) => {
            items.push(item.toJson());
        });
...
var metaField = (function (rdbmsitem) {
    ...
    metaField.TYPE_STRING = "string";metaField.TYPE_XBOOLEAN = "boolean";metaField.TYPE_INTEGER = "integer";metaField.TYPE_XFLOAT = "float";metaField.TYPE_DATE = "date";metaField.prototype.toJson = function() {
        var result = {};
        this.toJsonProperties(result);
        this.toJsonChildren(result);
        return result;
