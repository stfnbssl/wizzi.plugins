/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.plugins\packages\wizzi.plugin.rdbms\.wizzi-override\examples\dash_job.js.ittf
*/
'use strict';
...
var rdbms_examples_step_1 = function(step_callback) {
    heading1('First `rdbms` Wizzi Model')
    wizzi.fsFactory({
        plugins: {
            items: [
                './index', 
        ...
        wf.executeJob({
            name: "", 
            path: path.join(__dirname, 'ittf', 'dash', 'dash-rdbms.wfjob.ittf'), 
            ...
            console.log('dash-rdbms.wfjob.ittf result', result, __filename);
        }
        )
    }
    )
