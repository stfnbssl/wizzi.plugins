/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.plugins\packages\wizzi.plugin.rdbms\.wizzi-override\examples\rdbms_document.js.ittf
*/
'use strict';
...
function executeExample() {
    ...
    function executeGenerateModules(modules, callback) {
        async.mapSeries(modules, (module, callback) => {
            ...
            var outputPath = path.join(__dirname, 'results', module + '.rdbms.html');
            loadModelAndGenerateArtifact(ittfDocumentUri, {}, 'rdbms/document', (err, artifactText) => {
            
                if (err) {
                    return callback(err);
                }
                console.log('rdbms.example.executeGenerateModules.outputPath: ' + outputPath, __filename);
