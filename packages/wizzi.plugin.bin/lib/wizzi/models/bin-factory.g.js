/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.plugins\packages\wizzi.plugin.bin\.wizzi-override\lib\wizzi\models\bin-factory.g.js.ittf
...
var binmodel = require('./bin-model.g');
...
md.createLoadModel = function(wizziObject) {
    ...
    function loadModelFromMTree(mTree, ittfDocumentUri, wizziModelRequest, options, callback) {
        // loog 'wizzi.plugin.json.lib.wizzi.models.bin-factory.g, loaded from mTree'
        binmodel(mTree, ittfDocumentUri, wizziModelRequest, callback);
    }
    
    // Load a WizziModel of type 'bin' from an mTree
    ...
    /**
        // Load a WizziModel of type bin from an IttfDocument uri
        // params
    ...
    */
        ...
        return function loadModel(ittfDocumentUri, requestContext, callback) {
                ...
                loadMTree(ittfDocumentUri, requestContext, function(err, mTree) {
                    ...
                    // loog 'Loaded mTree instance for pseudo schema bin from Ittf document ' + ittfDocumentUri + ' in ' + (Date.now() - start) + ' ms'
                    ...
                    // loog 'wizzi.plugin.json.lib.wizzi.models.bin-factory.g current __dirname', __dirname
                    // loog 'wizzi.plugin.json.lib.wizzi.models.bin-factory.g, loaded from ittfDocumentUri: ', ittfDocumentUri, mTree
                    binmodel(mTree, ittfDocumentUri, wizziModelRequest, callback);
                })
            };
    }
...
function error(code, method, message, innerError) {
    ...
    return verify.error(innerError, {
        ...
        method: 'wizzi.plugin.json.lib.wizzi.models.bin-factory.g.' + method,
        parameter: parameter,
