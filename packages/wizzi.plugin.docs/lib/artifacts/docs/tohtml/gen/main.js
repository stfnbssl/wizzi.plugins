/*
    ...
    package: wizzi-js@
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.plugins\packages\wizzi.plugin.docs\.wizzi-override\lib\artifacts\docs\tohtml\gen\main.js.ittf
...
var myname = 'wizzi.plugin.docs.artifacts.docs.tohtml.gen.main';
...
md.gen = function(model, ctx, callback) {
    ...
    try {
        toHast.trans(model, {}, (err, hast) => {
        
            if (err) {
                return callback(err);
            }
            toHtml(hast, (err, result) => {
...
function error(errorName, method, message, model, innerError) {
    return new errors.WizziPluginError(message, model, {
            errorName: errorName, 
            method: 'wizzi.plugin.docs/lib/artifacts/docs/tohtml/gen/main.' + method, 
