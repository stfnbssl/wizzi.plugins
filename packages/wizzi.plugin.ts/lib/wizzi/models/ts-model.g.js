/*
    ...
    utc time: Tue, 07 Jan 2025 04:22:49 GMT
*/
...
/*
    artifact generator: C:\My\wizzi\stfnbssl\wizzi.plugins\packages\wizzi.plugin.js\lib\artifacts\js\module\gen\main.js
    package: @wizzi/plugin.js@0.8.9
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.plugins\packages\wizzi.plugin.ts\.wizzi-override\lib\wizzi\schemas\ts.wzschema.ittf
    utc time: Tue, 07 Jan 2025 04:22:49 GMT
*/
...
var statement = (function (tsBase) {
    ...
    statement.prototype.loadChild = function(child) {
        ...
        if (name === '!!') {
            return this.wzLoadToChildColl(child, _md.notnot, this.statements);
        }
        else if (name === '!=') {
            return this.wzLoadToChildColl(child, _md.op_noteq, this.statements);
        }
        if (name === '##') {
            return this.wzLoadToChildColl(child, _md.inlineMultilineComment, this.statements);
        }
        if (name === '&&') {
        ...
        if (name === '??') {
            return this.wzLoadToChildColl(child, _md.op_nullish, this.statements);
        }
        if (name === '@d') {
            return this.wzLoadToChildColl(child, _md.decorator, this.statements);
        }
        else if (name === '@_') {
            return this.wzLoadToChildColl(child, _md.decoratorCall, this.statements);
        }
        else if (name === '@[') {
            return this.wzLoadToChildColl(child, _md.jsPropertyOrValueComputed, this.statements);
        }
        if (name === '_`') {
        ...
        if (name === 'if') {
            ...
            return this.wzLoadToChildColl(child, _md.xin, this.statements);
        }
        if (name === 'js') {
        ...
        if (name === 'op') {
            ...
            return this.wzLoadToChildColl(child, _md.xof, this.statements);
        }
        if (name === '||') {
        ...
        if (name === '###') {
            return this.wzLoadToChildColl(child, _md.commentForReference, this.statements);
        }
        if (name === '...') {
        ...
        if (name === '#doc') {
            return this.wzLoadToChildColl(child, _md.jsDocComment, this.statements);
        }
        if (name === ':any') {
        ...
        if (name === 'left') {
            return this.wzLoadToChildColl(child, _md.xleft, this.statements);
        }
        else if (name === 'log?') {
        ...
        if (name === 'switch') {
            ...
            return this.wzLoadToChildColl(child, _md.styled, this.statements);
        }
        if (name === 'typeof') {
            return this.wzLoadToChildColl(child, _md.op_typeof, this.statements);
        }
        if (name === ':module') {
            ...
            return this.wzLoadToChildColl(child, _md.typeSymbol, this.statements);
        }
        else if (name === ':object') {
        ...
        if (name === 'literal') {
            return this.wzLoadToChildColl(child, _md.literal, this.statements);
        }
        if (name === 'require') {
        ...
        if (name === 'directive') {
            return this.wzLoadToChildColl(child, _md.directive, this.statements);
        }
        else if (name === 'did-mount') {
            return this.wzLoadToChildColl(child, _md.didMount, this.statements);
        }
        ...
        if (name === 'keyframes') {
            return this.wzLoadToChildColl(child, _md.keyframes, this.statements);
        }
        if (name === 'satisfies') {
            return this.wzLoadToChildColl(child, _md.satisfies, this.statements);
        }
        ...
        else if (name === 'styledcss') {
            return this.wzLoadToChildColl(child, _md.styledCss, this.statements);
        }
        if (name === 'willmount') {
...
_md.comment = comment;
// element commentForReference
var commentForReference = (function (statement) {
    _inherits(commentForReference, statement);
    function commentForReference(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(commentForReference.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, commentForReference);
        this.wzElement = "commentForReference";
    }
    return commentForReference;
})(statement);

_md.commentForReference = commentForReference;
// element inlineMultilineComment
var inlineMultilineComment = (function (statement) {
    _inherits(inlineMultilineComment, statement);
    function inlineMultilineComment(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(inlineMultilineComment.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, inlineMultilineComment);
        this.wzElement = "inlineMultilineComment";
    }
    return inlineMultilineComment;
})(statement);

_md.inlineMultilineComment = inlineMultilineComment;
// element jsDocComment
var jsDocComment = (function (statement) {
    _inherits(jsDocComment, statement);
    function jsDocComment(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(jsDocComment.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, jsDocComment);
        this.wzElement = "jsDocComment";
    }
    return jsDocComment;
})(statement);

_md.jsDocComment = jsDocComment;
/**
    element xmodule
...
_md.feature = feature;
// element decorator
var decorator = (function (statement) {
    _inherits(decorator, statement);
    function decorator(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(decorator.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, decorator);
        this.wzElement = "decorator";
    }
    return decorator;
})(statement);

_md.decorator = decorator;
// element directive
var directive = (function (statement) {
    _inherits(directive, statement);
...
_md.not = not;
// element notnot
var notnot = (function (statement) {
    _inherits(notnot, statement);
    function notnot(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(notnot.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, notnot);
        this.wzElement = "notnot";
    }
    return notnot;
})(statement);
...
_md.and = and;
// element op_nullish
var op_nullish = (function (statement) {
    _inherits(op_nullish, statement);
    function op_nullish(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(op_nullish.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, op_nullish);
        this.wzElement = "op_nullish";
    }
    return op_nullish;
})(statement);

_md.op_nullish = op_nullish;
...
/**
    element op_typeof
     ...
     typeof Foo
*/
var op_typeof = (function (statement) {
    _inherits(op_typeof, statement);
    function op_typeof(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(op_typeof.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, op_typeof);
        this.wzElement = "op_typeof";
    }
    return op_typeof;
})(statement);

_md.op_typeof = op_typeof;
// element xrequire
...
// element literal
var literal = (function (statement) {
    _inherits(literal, statement);
...
/**
    element set
     ...
     fundamental in the 'ts' language schema.
...
// element satisfies
var satisfies = (function (statement) {
    _inherits(satisfies, statement);
    function satisfies(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(satisfies.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, satisfies);
        this.wzElement = "satisfies";
    }
    return satisfies;
})(statement);

_md.satisfies = satisfies;
/**
    element xif
...
_md.xfor = xfor;
// element xleft
var xleft = (function (statement) {
    _inherits(xleft, statement);
    function xleft(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(xleft.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, xleft);
        this.wzElement = "xleft";
    }
    return xleft;
})(statement);
...
_md.xleft = xleft;
// element xof
var xof = (function (statement) {
    _inherits(xof, statement);
    function xof(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(xof.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, xof);
        this.wzElement = "xof";
    }
    return xof;
})(statement);
...
_md.xof = xof;
// element xin
var xin = (function (statement) {
    _inherits(xin, statement);
...
// element jsPropertyOrValueComputed
var jsPropertyOrValueComputed = (function (statement) {
    _inherits(jsPropertyOrValueComputed, statement);
    function jsPropertyOrValueComputed(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(jsPropertyOrValueComputed.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, jsPropertyOrValueComputed);
        this.wzElement = "jsPropertyOrValueComputed";
    }
    jsPropertyOrValueComputed.prototype.wzInitialize = function(ctx) {
    ...
    return jsPropertyOrValueComputed;
})(statement);

_md.jsPropertyOrValueComputed = jsPropertyOrValueComputed;
// element jsRest
...
var arrowfunction = (function (xfunction) {
    ...
    arrowfunction.prototype.wzVerify = function(ctx) {
        if (this.typeReturn != null) {
            this.typeReturn.wzVerify(ctx);
        }
        _md.xfunction.prototype.wzVerify.call(this, ctx);
    }
    arrowfunction.prototype.wzInitialize = function(ctx) {
        if (this.typeReturn != null) {
            this.typeReturn.wzInitialize(ctx);
        }
...
var asyncarrowfunction = (function (xfunction) {
    ...
    asyncarrowfunction.prototype.loadChild = function(child) {
        var ok = false, name = child.n.toLowerCase();
        if (name === ':public') {
            this.typePublic = parseboolean(child.v, true, child); return true;
        }
    ...
    asyncarrowfunction.prototype.loadFromNode = function(node) {
        node.children.forEach((item) => {
            var loaded = this.loadChild(item);
            if (!loaded) {
                throw new _md.tsModelException("Tag not recognized: " + item.n, item, this);
...
var typeExtends = (function (statement) {
    ...
    typeExtends.prototype.wzInitialize = function(ctx) {
...
var typeMethod = (function (xfunction) {
    ...
    typeMethod.prototype.wzVerify = function(ctx) {
        if (this.typeReturn != null) {
            this.typeReturn.wzVerify(ctx);
        }
        _md.xfunction.prototype.wzVerify.call(this, ctx);
    }
    typeMethod.prototype.wzInitialize = function(ctx) {
        if (this.typeReturn != null) {
            this.typeReturn.wzInitialize(ctx);
        }
        _md.xfunction.prototype.wzInitialize.call(this, ctx);
...
var get = (function (xfunction) {
    ...
    get.prototype.loadChild = function(child) {
        var ok = false, name = child.n.toLowerCase();
        if (name === 'static') {
    ...
    get.prototype.loadFromNode = function(node) {
        node.children.forEach((item) => {
            var loaded = this.loadChild(item);
            if (!loaded) {
                throw new _md.tsModelException("Tag not recognized: " + item.n, item, this);
...
// element styled
var styled = (function (htmlelement) {
    _inherits(styled, htmlelement);
    function styled(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(styled.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, styled);
        this.wzElement = "styled";
        this.global = false;
        this.css_css_items = [];
    }
    styled.prototype.loadChild = function(child) {
        var ok = false, name = child.n.toLowerCase();
        if (name === 'css') {
            // generated by wizzi/lib/wizzi/models/bootstrap/t/wfschema/t/element_load;
            this.css_css_items.push(child);
    ...
    styled.prototype.loadFromNode = function(node) {
        node.children.forEach((item) => {
            var loaded = this.loadChild(item);
            if (!loaded) {
                throw new _md.tsModelException("Tag not recognized: " + item.n, item, this);
...
_md.styled = styled;
// element styledCss
var styledCss = (function (htmlelement) {
    _inherits(styledCss, htmlelement);
    function styledCss(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(styledCss.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, styledCss);
        this.wzElement = "styledCss";
        this.global = false;
        this.css_css_items = [];
    }
    styledCss.prototype.loadChild = function(child) {
        var ok = false, name = child.n.toLowerCase();
        if (name === 'css') {
            // generated by wizzi/lib/wizzi/models/bootstrap/t/wfschema/t/element_load;
            this.css_css_items.push(child);
    ...
    styledCss.prototype.loadFromNode = function(node) {
        node.children.forEach((item) => {
            var loaded = this.loadChild(item);
            if (!loaded) {
                throw new _md.tsModelException("Tag not recognized: " + item.n, item, this);
...
_md.styledCss = styledCss;
// element keyframes
var keyframes = (function (statement) {
    _inherits(keyframes, statement);
...
_md.typeAny = typeAny;
// element typeSymbol
var typeSymbol = (function (typeSimple) {
    _inherits(typeSymbol, typeSimple);
    function typeSymbol(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(typeSymbol.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, typeSymbol);
        this.wzElement = "typeSymbol";
    }
    return typeSymbol;
})(typeSimple);

_md.typeSymbol = typeSymbol;
// element typeArray
...
var typeArrowFunction = (function (xfunction) {
    ...
    typeArrowFunction.prototype.loadChild = function(child) {
        var ok = false, name = child.n.toLowerCase();
        if (name === ':return') {
            return this.wzLoadOneToOne(child, _md.typeReturn, 'typeReturn');
        }
    ...
    typeArrowFunction.prototype.loadFromNode = function(node) {
        node.children.forEach((item) => {
            var loaded = this.loadChild(item);
            if (!loaded) {
                throw new _md.tsModelException("Tag not recognized: " + item.n, item, this);
    ...
    typeArrowFunction.prototype.wzVerify = function(ctx) {
        if (this.typeReturn != null) {
            this.typeReturn.wzVerify(ctx);
        }
        _md.xfunction.prototype.wzVerify.call(this, ctx);
    }
    typeArrowFunction.prototype.wzInitialize = function(ctx) {
        if (this.typeReturn != null) {
            this.typeReturn.wzInitialize(ctx);
        }
        _md.xfunction.prototype.wzInitialize.call(this, ctx);
...
var typeExport = (function (statement) {
    ...
    typeExport.prototype.loadChild = function(child) {
        var ok = false, name = child.n.toLowerCase();
        if (name === 'as') {
            this.xas = child.v; return true;
        }
    ...
    typeExport.prototype.loadFromNode = function(node) {
        node.children.forEach((item) => {
            var loaded = this.loadChild(item);
            if (!loaded) {
                throw new _md.tsModelException("Tag not recognized: " + item.n, item, this);
    ...
    typeExport.prototype.wzInitialize = function(ctx) {
...
var typeImport = (function (statement) {
    ...
    typeImport.prototype.loadChild = function(child) {
        var ok = false, name = child.n.toLowerCase();
        if (name === 'as') {
            this.xas = child.v; return true;
        }
    ...
    typeImport.prototype.loadFromNode = function(node) {
        node.children.forEach((item) => {
            var loaded = this.loadChild(item);
            if (!loaded) {
                throw new _md.tsModelException("Tag not recognized: " + item.n, item, this);
    ...
    typeImport.prototype.wzInitialize = function(ctx) {
