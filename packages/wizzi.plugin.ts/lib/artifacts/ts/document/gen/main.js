/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.plugins\packages\wizzi.plugin.ts\.wizzi-override\lib\artifacts\ts\document\gen\main.js.ittf
*/
'use strict';
...
var myname = 'wizzi.plugin.ts.artifacts.ts.document.gen.main';
...
function error(errorName, method, message, model, innerError) {
    return new errors.WizziPluginError(message, model, {
            errorName: errorName, 
            method: 'wizzi.plugin.ts/lib/artifacts/ts/document/gen/main.' + method, 
