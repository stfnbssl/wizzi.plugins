/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.plugins\packages\wizzi.plugin.java\.wizzi-override\root\index.js.ittf
*/
'use strict';
...
md.name = 'wizzi.plugin.java.index';

// window(s) vars must be declared even if empty
var window_modelFactories = {
    'java': require('./lib/wizzi/models/java-factory.g')
 };
var window_artifactGenerators = {
    'java/document': require('./lib/artifacts/java/document/gen/main')
 };
var window_transformers = {
    'java/extended': require('./lib/artifacts/java/extended/trans/main')
 };
