/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.plugins\packages\wizzi.plugin.java\.wizzi-override\lib\artifacts\java\module\gen\writers\helpers.js.ittf
*/
'use strict';
var verify = require('../utils/verify');
var myname = 'wizzi.plugin.java.lib.artifacts.module.gen.writers.helpers';
...
;
md.genParams = function(model, ctx, mainWriter, callback) {
    ...
    function repeater_1(index_1) {
        ...
        if ((!p.statements || p.statements.length == 0) && (!p.jsPropertyOrValues || p.jsPropertyOrValues.length == 0)) {
            ...
            mainWriter.statementsContainer[p.wzElement](p, ctx, (err, notUsed) => {
        ...
        // loog 'genParams.s0.statements.length', s0.statements.length
            ...
            genParams_close(s0, ctx, mainWriter, (err, notUsed) => {
...
;
function genParams_close(s0, ctx, mainWriter, callback) {
    ...
    // loog 'genParams_close 3 item.wzElement', s0.wzElement
        ...
        ctx.write(' = ');
        mainWriter.statementsContainer[s0.wzElement](s0, ctx, callback)
    }
}
md.genTSParams = function(model, ctx, mainWriter, callback) {
    if (!!(model.params && model.params.length > 0) == false) {
        return callback(null);
    }
    ...
    function repeater_1(index_1) {
        ...
        if (p.statements.length == 0) {
            ...
            if (ptype) {
                ctx.write(': ');
                mainWriter.statementsContainer[ptype.wzElement](ptype, ctx, (err, notUsed) => {
        ...
        // throw new Error('jswizzifier.genTSParams.statements[0].wzElement should be "typeInitValue or typeCTor".found: ' + s0.wzElement)
            ...
            if (ptype) {
                ...
                mainWriter.statementsContainer[ptype.wzElement](ptype, ctx, (err, notUsed) => {
                    ...
                    genTSParams_close(s0, ctx, mainWriter, (err, notUsed) => {
...
;
function genTSParams_close(s0, ctx, mainWriter, callback) {
...
;
md.genTSTypeParameters = function(model, ctx, mainWriter, callback) {
    // loog 'model.statements.length', model.statements.length, 'Object.keys(model)', Object.keys(model)
    genTSTypeParameters_partial(model, ctx, mainWriter, (err, notUsed) => {
...
;
function genTSTypeParameters_partial(model, ctx, mainWriter, callback) {
    if (model.typeParameterDecls && model.typeParameterDecls.length > 0) {
        ...
        function repeater_1(index_1) {
            ...
            mainWriter.statementsContainer.typeParameterDecl(item_1, ctx, (err, notUsed) => {
...
md.genTSTypeParameterInsts = function(model, ctx, mainWriter, callback) {
...
;
md.genTSDecorators = function(model, ctx, mainWriter, callback) {
    var decorators = [];
    var temp = [];
    ...
    if (decorators.length > 0) {
        ...
        function repeater_1(index_1) {
            ...
            mainWriter.statementsContainer.decorator(item_1, ctx, (err, notUsed) => {
