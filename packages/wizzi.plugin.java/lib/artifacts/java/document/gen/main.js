/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.plugins\packages\wizzi.plugin.java\.wizzi-override\lib\artifacts\java\document\gen\main.js.ittf
*/
'use strict';
...
var myname = 'wizzi.plugin.java.artifacts.java.document.gen.main';
...
md.gen = function(model, ctx, callback) {
    ...
    if (model.wzElement !== 'java') {
        callback(error('InvalidArgument', 'gen', 'Invalid model schema. Expected root element "java". Received: ' + model.wzElement, model))
    }
    try {
        md.java(model, ctx, (err, notUsed) => {
...
;
md.java = function(model, ctx, callback) {
    ctx.w('<java>');
...
function error(errorName, method, message, model, innerError) {
    return new errors.WizziPluginError(message, model, {
            errorName: errorName, 
            method: 'wizzi.plugin.java/lib/artifacts/java/document/gen/main.' + method, 
