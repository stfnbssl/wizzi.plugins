/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.plugins\packages\wizzi.plugin.java\.wizzi-override\examples\java_document.js.ittf
*/
'use strict';
...
function executeExample() {
    ...
    function executeGenerateModules(modules, callback) {
        async.mapSeries(modules, (module, callback) => {
            ...
            var outputPath = path.join(__dirname, 'results', module + '.java.html');
            loadModelAndGenerateArtifact(ittfDocumentUri, {}, 'java/document', (err, artifactText) => {
            
                if (err) {
                    return callback(err);
                }
                console.log('java.example.executeGenerateModules.outputPath: ' + outputPath, __filename);
