...
var regExp = (function (fieldConstraint) {
    ...
    regExp.prototype.toJsonProperties = function(result) {
        ...
        if (!isEmpty(this.explain)) {
            result["explain"] = this.explain;
        }
    }
    regExp.prototype.toJsonChildren = function(result) {
        _md.fieldConstraint.prototype.toJsonChildren.call(this, result);
    }
    regExp.prototype.loadChild = function(child) {
        var ok = false, name = child.n.toLowerCase();
        if (name === 'explain') {
            this.explain = child.v; return true;
        }
        ok = _md.fieldConstraint.prototype.loadChild.call(this, child);
        return ok;
    }
    regExp.prototype.loadFromNode = function(node) {
        node.children.forEach((item) => {
            var loaded = this.loadChild(item);
            if (!loaded) {
                throw new _md.prismaModelException("Tag not recognized: " + item.n, item, this);
    ...
    regExp.prototype.setField = function(field) {
        ...
        */
        ...
        field.regExpExplain = this.explain;
    }
    return regExp;
})(fieldConstraint);
