...
var line = (function (element) {
    ...
    line.prototype.getAttributes = function(attrs) {
        ...
        */
        attrs = _md.element.prototype.getAttributes.call(this, attrs);
        ;
        return extractAttributes(this, 'x1;y1;x2;y2;markerEnd;markerMid;markerStart', attrs);
    }
    return line;
})(element);
...
var polyline = (function (element) {
    ...
    polyline.prototype.getAttributes = function(attrs) {
        ...
        */
        attrs = _md.element.prototype.getAttributes.call(this, attrs);
        ;
        return extractAttributes(this, 'points;markerEnd;markerMid;markerStart', attrs);
    }
    return polyline;
})(element);
...
var path = (function (element) {
    ...
    path.prototype.getAttributes = function(attrs) {
        ...
        */
        attrs = _md.element.prototype.getAttributes.call(this, attrs);
        ;
        return extractAttributes(this, 'd;fillOpacity', attrs);
    }
    return path;
})(element);
...
var animate = (function (element) {
    ...
    animate.prototype.loadChild = function(child) {
        var ok = false, name = child.n.toLowerCase();
        if (name === 'dur') {
    ...
    animate.prototype.loadFromNode = function(node) {
        node.children.forEach((item) => {
            var loaded = this.loadChild(item);
            if (!loaded) {
                throw new _md.svgModelException("Tag not recognized: " + item.n, item, this);
    ...
    animate.prototype.getAttributes = function(attrs) {
        ...
        */
        attrs = _md.element.prototype.getAttributes.call(this, attrs);
        ;
        return extractAttributes(this, 'attributeName;values;dur;repeatCount;begin', attrs);
    }
    return animate;
})(element);
...
var marker = (function (element) {
    ...
    marker.prototype.loadChild = function(child) {
        var ok = false, name = child.n.toLowerCase();
        if (name === 'ref-x') {
        ...
        if (name === 'marker-width') {
            this.markerWidth = child.v; return true;
        }
        else if (name === 'marker_width') {
            this.markerWidth = child.v; return true;
        }
        else if (name === 'marker-units') {
            this.markerUnits = child.v; return true;
        }
        else if (name === 'marker_units') {
            this.markerUnits = child.v; return true;
        }
        if (name === 'marker-height') {
            this.markerHeight = child.v; return true;
        }
        else if (name === 'marker_height') {
            this.markerHeight = child.v; return true;
        }
        ok = _md.element.prototype.loadChild.call(this, child);
        return ok;
    }
    marker.prototype.loadFromNode = function(node) {
        node.children.forEach((item) => {
            var loaded = this.loadChild(item);
            if (!loaded) {
                throw new _md.svgModelException("Tag not recognized: " + item.n, item, this);
    ...
    marker.prototype.getAttributes = function(attrs) {
        ...
        */
        attrs = _md.element.prototype.getAttributes.call(this, attrs);
        ;
        return extractAttributes(this, 'refX;refY;markerWidth;markerHeight;markerUnits;orient;viewBox', attrs);
    }
    return marker;
})(element);
