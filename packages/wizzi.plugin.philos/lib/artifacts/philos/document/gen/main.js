/*
    ...
    package: wizzi-js@
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.plugins\packages\wizzi.plugin.philos\.wizzi-override\lib\artifacts\philos\document\gen\main.js.ittf
...
var myname = 'wizzi.plugin.philos.artifacts.philos.document.gen.main';
...
md.gen = function(model, ctx, callback) {
    ...
    if (model.wzElement !== 'philos') {
        return callback(error('InvalidArgument', 'gen', 'Invalid model schema. Expected root element "philos". Received: ' + model.wzElement, model));
    }
    try {
        md.philos(model, ctx, (err, notUsed) => {
...
function error(errorName, method, message, model, innerError) {
    return new errors.WizziPluginError(message, model, {
            errorName: errorName, 
            method: 'wizzi.plugin.philos/lib/artifacts/philos/document/gen/main.' + method, 
