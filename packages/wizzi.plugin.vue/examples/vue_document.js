/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.plugins\packages\wizzi.plugin.vue\.wizzi-override\examples\vue_document.js.ittf
*/
'use strict';
...
function executeExample() {
    ...
    function executeGenerateModules(modules, callback) {
        async.mapSeries(modules, (module, callback) => {
            ...
            var outputPath = path.join(__dirname, 'results', module + '.vue.document.html');
            loadWizziModel(ittfDocumentUri, {}, (err, wizziModel) => {
                ...
                loadModelAndGenerateArtifact(ittfDocumentUri, {}, 'vue/document', (err, artifactText) => {
                
                    if (err) {
                        return callback(err);
                    }
                    console.log('vue.example.executeGenerateModules.outputPath: ' + outputPath, __filename);
