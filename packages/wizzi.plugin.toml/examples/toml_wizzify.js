/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.plugins\packages\wizzi.plugin.toml\.wizzi-override\examples\toml_wizzify.js.ittf
...
function executeExample() {
    ...
    function wizzify(name, callback) {
        ...
        createWizziFactory({}, (err, wf) => 
            ...
            tomlwizzifier.getWizziIttf(file.read(source), {
                wf: wf, 
                ...
                file.write(path.join(__dirname, 'data', 'output', name + '.toml.ittf'), ittf)
