/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.plugins\packages\wizzi.plugin.toml\.wizzi-override\lib\artifacts\toml\document\gen\main.js.ittf
...
var myname = 'wizzi.plugin.toml.artifacts.toml.document.gen.main';
...
;
md.toml = function(model, ctx, callback) {
    ctx.w(TOML.stringify(model))
...
function error(errorName, method, message, model, innerError) {
    return new errors.WizziPluginError(message, model, {
            errorName: errorName, 
            method: 'wizzi.plugin.toml/lib/artifacts/toml/document/gen/main.' + method, 
