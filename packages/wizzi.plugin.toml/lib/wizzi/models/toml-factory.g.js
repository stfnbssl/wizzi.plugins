/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.plugins\packages\wizzi.plugin.toml\.wizzi-override\lib\wizzi\models\toml-factory.g.js.ittf
...
var tomlmodel = require('./toml-model.g');
...
md.createLoadModel = function(wizziObject) {
    ...
    function loadModelFromMTree(mTree, ittfDocumentUri, wizziModelRequest, options, callback) {
        // loog 'wizzi.plugin.toml.lib.wizzi.models.toml-factory.g, loaded from mTree'
        tomlmodel(mTree, ittfDocumentUri, wizziModelRequest, callback);
    }
    
    // Load a WizziModel of type 'toml' from an mTree
    ...
    /**
        // Load a WizziModel of type toml from an IttfDocument uri
        // params
    ...
    */
        ...
        return function loadModel(ittfDocumentUri, requestContext, callback) {
                ...
                loadMTree(ittfDocumentUri, requestContext, function(err, mTree) {
                    ...
                    // loog 'Loaded mTree instance for pseudo schema toml from Ittf document ' + ittfDocumentUri + ' in ' + (Date.now() - start) + ' ms'
                    ...
                    // loog 'wizzi.plugin.toml.lib.wizzi.models.toml-factory.g current __dirname', __dirname
                    // loog 'wizzi.plugin.toml.lib.wizzi.models.toml-factory.g, loaded from ittfDocumentUri: ', ittfDocumentUri, mTree
                    tomlmodel(mTree, ittfDocumentUri, wizziModelRequest, callback);
                })
            };
    }
...
function error(code, method, message, innerError) {
    ...
    return verify.error(innerError, {
        ...
        method: 'wizzi.plugin.toml.lib.wizzi.models.toml-factory.g.' + method,
        parameter: parameter,
