/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.plugins\packages\wizzi.plugin.js\.wizzi-override\lib\artifacts\js\module\gen\statements\if-switch.js.ittf
...
var myname = 'wizzi-js.artifacts.js.module.gen.statements.if-switch';
...
md.load = function(cnt) {
    ...
    cnt.stm.xswitch = function(model, ctx, callback) {
        ...
        if (verify.isEmpty(model.wzName)) {
            ...
            if (!condition) {
                return callback(ctx.error("Malformed switch. Should be: `switch` <condition> or to have a child conditional statement of `switch`", model));
            }
            model.statements = temp;
            ctx.write('switch (');
