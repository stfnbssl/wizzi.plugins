/*
    ...
    package: wizzi-js@
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.plugins\packages\wizzi.plugin.js\.wizzi-override\lib\artifacts\js\module\gen\es6\setter.js.ittf
    utc time: Tue, 09 Apr 2024 12:27:05 GMT
*/
'use strict';
var statement = require('../statement');
var md = module.exports = {};
var myname = 'wizzi.js.artifacts.module.gen.es6.setter';
md.gen = function(model, ctx, callback) {
    var method = model.wzName;
    ctx.w('set ' + method + '(' + model.paramNames.join(', ') + ') {');
    ctx.indent();
