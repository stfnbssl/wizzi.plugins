/*
    ...
    package: wizzi-js@
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.plugins\packages\wizzi.plugin.js\.wizzi-override\examples\js_document.js.ittf
...
function executeExample() {
    ...
    function executeGenerateModules(modules, callback) {
        async.mapSeries(modules, (module, callback) => {
            ...
            var outputPath = path.join(__dirname, 'results', module + '.js.document.html');
            loadWizziModel(ittfDocumentUri, {}, (err, wizziModel) => {
                ...
                loadModelAndGenerateArtifact(ittfDocumentUri, {}, 'js/module', (err, artifactText) => {
                    ...
                    console.log('js.example.executeGenerateModules.outputPath: ' + outputPath, __filename);
