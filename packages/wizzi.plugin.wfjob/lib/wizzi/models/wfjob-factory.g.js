...
md.createLoadModel = function(wizziObject) {
    ...
    */
        ...
        return function loadModel(ittfDocumentUri, loadContext, callback) {
                ...
                console.log("wizzi.plugin.wfjob.loadContext.__productionManager.globalContext()", loadContext.__productionManager.globalContext());
                ...
                console.log("wizzi.plugin.wfjob.loadContext.mTreeBuildUpContext", loadContext.mTreeBuildUpContext);
