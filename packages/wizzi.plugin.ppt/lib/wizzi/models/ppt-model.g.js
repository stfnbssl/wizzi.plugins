...
var node = (function (pptBase) {
    ...
    node.prototype.loadChild = function(child) {
        ...
        if (name === '::media') {
            return this.wzLoadToChildColl(child, _md.svgInclude, this.nodes);
        }
        if (name === 'allcaps') {
...
var pageMargins = (function (node) {
    ...
    pageMargins.prototype.wzInitialize = function(ctx) {
        ...
        /*
            artifact generator: C:\My\wizzi\stfnbssl\wizzi.plugins\packages\wizzi.plugin.js\lib\artifacts\js\module\gen\main.js
            package: @wizzi/plugin.js@0.8.9
            primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.plugins\packages\wizzi.plugin.ppt\.wizzi-override\lib\wizzi\schemas\ppt.wzschema.ittf
            utc time: Fri, 06 Jun 2025 19:59:25 GMT
        */
...
// element svgInclude
var svgInclude = (function (node) {
    _inherits(svgInclude, node);
