...
var node = (function (pdfBase) {
    ...
    node.prototype.loadChild = function(child) {
        ...
        if (name === 'a') {
            return this.wzLoadToChildColl(child, _md.a, this.nodes);
        }
        if (name === 'b') {
        ...
        if (name === 'svg') {
            return this.wzLoadToChildColl(child, _md.svg, this.nodes);
        }
        if (name === 'bold') {
        ...
        if (name === 'json') {
            return this.wzLoadToChildColl(child, _md.json, this.nodes);
        }
        if (name === 'node') {
...
var pageMargins = (function (node) {
    ...
    pageMargins.prototype.wzInitialize = function(ctx) {
        ...
        /*
            artifact generator: C:\My\wizzi\stfnbssl\wizzi.plugins\packages\wizzi.plugin.js\lib\artifacts\js\module\gen\main.js
            package: @wizzi/plugin.js@0.8.9
            primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.plugins\packages\wizzi.plugin.pdf\.wizzi-override\lib\wizzi\schemas\pdf.wzschema.ittf
            utc time: Sat, 28 Dec 2024 06:59:28 GMT
        */
...
var json = (function (node) {
    ...
    json.prototype.wzVerify = function(ctx) {
        ctx.verifyEnum("json", "tab", this.tab, this.allowedTABS, this);
...
var a = (function (node) {
    ...
    a.prototype.loadChild = function(child) {
        ...
        if (name === 'page') {
            this.page = child.v; return true;
        }
        if (name === 'destination') {
            this.destination = child.v; return true;
        }
        ok = _md.node.prototype.loadChild.call(this, child);
        return ok;
    }
...
var svg = (function (node) {
    ...
    svg.prototype.loadChild = function(child) {
        ...
        if (name === '::markup') {
            return this.wzLoadOneToOne(child, _md.svgInclude, 'svgInclude');
        }
        ok = _md.node.prototype.loadChild.call(this, child);
        return ok;
    }
    ...
    svg.prototype.wzVerify = function(ctx) {
        if (this.svgInclude != null) {
            this.svgInclude.wzVerify(ctx);
        }
        _md.node.prototype.wzVerify.call(this, ctx);
    }
    svg.prototype.wzInitialize = function(ctx) {
        if (this.svgInclude != null) {
            this.svgInclude.wzInitialize(ctx);
        }
        _md.node.prototype.wzInitialize.call(this, ctx);
    }
    return svg;
...
var pdfContext = (function () {
    ...
    pdfContext.prototype.verifyEnum = function(valueType, valueName, value, allowed, node) {
