...
md.name = 'wizzi.plugin.c.index';

// window(s) vars must be declared even if empty
var window_modelFactories = {
    'c': require('./lib/wizzi/models/c-factory.g')
 };
var window_artifactGenerators = {
    'c/document': require('./lib/artifacts/c/document/gen/main')
 };
var window_transformers = {
    'c/extended': require('./lib/artifacts/c/extended/trans/main')
 };
