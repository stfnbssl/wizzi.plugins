/*
    ...
    package: wizzi-js@
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.plugins\packages\wizzi.plugin.c\.wizzi-override\examples\step_2_go.js.ittf
...
var artifactContext = {};
var globalContext = {};
var c_examples_step_2 = function(step_callback) {
    heading1('Second `c` Wizzi Model')
    wizzi.fsFactory({
        plugins: {
            items: [
                './index'
        ...
        wf.loadModelAndGenerateArtifact(path.join(__dirname, 'step_2', 'first.c.ittf'), {
            ...
            const resultScriptPath = path.join(__dirname, 'step_2', 'result', 'step2.c');
            const exePath = path.join(__dirname, 'step_2', 'result', 'step2.exe');
...
c_examples_step_2.__name = 'Level 0 - c_examples_step_2';
function heading1(text) {
    console.log('');
    console.log('*'.repeat(120));
    console.log('** level 0 - step 2 - c_examples_step_2 - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
function heading2(text) {
    ...
    console.log('   ','-- c_examples_step_2 - ' + text);
    console.log('   ', '-'.repeat(100));
    console.log('');
}
...
module.exports = c_examples_step_2;
