/*
    ...
    package: wizzi-js@
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.plugins\packages\wizzi.plugin.wzschema\.wizzi-override\examples\wzschema_schemaboot.js.ittf
...
function executeExample() {
    ...
    function executeGenerateModules(modules, callback) {
        async.mapSeries(modules, (module, callback) => {
            ...
            var outputLoadedPath = path.join(__dirname, 'results', 'wzschema', module + '.wzschema.json');
            var outputExtendedPath = path.join(__dirname, 'results', 'wzschema', module + '.wzschema.schemaboot.json');
            loadWizziModel(ittfDocumentUri, {}, (err, model) => {
            
                if (err) {
                    return callback(err);
                }
                loadModelAndTransform(ittfDocumentUri, {}, "wzschema/schemaboot", (err, model) => {
