...
/*
    artifact generator: C:\My\wizzi\stfnbssl\wizzi.plugins\packages\wizzi.plugin.wzschema\node_modules\wizzi-js\lib\artifacts\js\module\gen\main.js
    package: wizzi-js@0.7.13
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.plugins\packages\wizzi.plugin.wzschema\examples\ittf\first.wfschema.ittf
*/
function Hello() {
...
_md.kind2 = kind2;
// element statement
var statement = (function (secondBase) {
    _inherits(statement, secondBase);
...
// element param
var param = (function (secondBase) {
    _inherits(param, secondBase);
...
_md.__tagElementMapping = { '#': 'comment', '@': 'directiveA', '§': 'directiveB', '-': 'node', 'k1': 'kind1', 'k2': 'kind2', 'function': 'xfunction' };
