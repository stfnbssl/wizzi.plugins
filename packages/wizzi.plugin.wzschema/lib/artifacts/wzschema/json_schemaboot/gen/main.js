/*
    ...
    package: wizzi-js@
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.plugins\packages\wizzi.plugin.wzschema\.wizzi-override\lib\artifacts\wzschema\json_schemaboot\gen\main.js.ittf
...
var myname = 'wizzi.plugin.wzschema.artifacts.wzschema.json_schemaboot.gen.main';
...
function error(errorName, method, message, model, innerError) {
    return new errors.WizziPluginError(message, model, {
            errorName: errorName, 
            method: 'wizzi.plugin.wzschema/lib/artifacts/wzschema/json_schemaboot/gen/main.' + method, 
