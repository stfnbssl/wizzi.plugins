...
// element comment
var comment = (function (wzschemaBase) {
    _inherits(comment, wzschemaBase);
    ...
    comment.prototype.loadChild = function(child) {
        ...
        if (name === 'wzschema') {
            return this.wzLoadToChildColl(child, _md.wzschema, this.comments);
        }
        if (name === 'export-to') {
            return this.wzLoadToChildColl(child, _md.exportTo, this.comments);
        }
...
// element wzschema
var wzschema = (function (schemaitem) {
    _inherits(wzschema, schemaitem);
    ...
    wzschema.prototype.addExportTo = function(name, sourceLineInfo) {
        var retval = new _md.exportTo(name, sourceLineInfo);
        retval.wzParent = this;
        this.exportTos.push(retval);
        return retval;
    }
    wzschema.prototype.getExportTo = function(name) {
        var found = null;
    ...
    wzschema.prototype.addXrequire = function(name, sourceLineInfo) {
        var retval = new _md.xrequire(name, sourceLineInfo);
        retval.wzParent = this;
        this.requires.push(retval);
        return retval;
    }
    wzschema.prototype.getXrequire = function(name) {
        var found = null;
    ...
    wzschema.prototype.addMethod = function(name, sourceLineInfo) {
        var retval = new _md.method(name, sourceLineInfo);
        retval.wzParent = this;
        this.methods.push(retval);
        return retval;
    }
    wzschema.prototype.getMethod = function(name) {
        var found = null;
    ...
    wzschema.prototype.addDeclare = function(name, sourceLineInfo) {
        var retval = new _md.declare(name, sourceLineInfo);
        retval.wzParent = this;
        this.declares.push(retval);
        return retval;
    }
    wzschema.prototype.getDeclare = function(name) {
        var found = null;
...
var declare = (function (schemaitem) {
    ...
    declare.prototype.loadChild = function(child) {
        var ok = false, name = child.n.toLowerCase();
        if (name === '::js') {
            return this.wzLoadToChildColl(child, _md.jsInclude, this.statements);
        }
        if (name === 'statement') {
...
// element jsInclude
var jsInclude = (function (statement) {
    _inherits(jsInclude, statement);
...
_md.__tagElementMapping = { '#': 'comment', 'e': 'element', 'a': 'attribute', 'r': 'relation', 'enum': 'enumFacet', 'max-length': 'maxLengthFacet', 'maxlength': 'maxLengthFacet', 'min-length': 'minLengthFacet', 'minlength': 'minLengthFacet', 'max-value': 'maxValueFacet', 'maxvalue': 'maxValueFacet', 'min-value': 'minValueFacet', 'minvalue': 'minValueFacet', 'regexp': 'regexpFacet', 'element': 'elementFacet', 'export-to': 'exportTo', 'exportto': 'exportTo', 'require': 'xrequire', 'm': 'method', '::js': 'jsInclude' };
...
var wzschemaContext = (function () {
    ...
    wzschemaContext.prototype.verifyEnum = function(valueType, valueName, value, allowed, node) {
