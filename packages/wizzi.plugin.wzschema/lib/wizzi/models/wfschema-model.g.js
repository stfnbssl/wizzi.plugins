...
_md.param = param;
_md.__tagElementMapping = { '#': 'comment', 'e': 'element', 'a': 'attribute', 'r': 'relation', 'enum': 'enumFacet', 'max-length': 'maxLengthFacet', 'maxlength': 'maxLengthFacet', 'min-length': 'minLengthFacet', 'minlength': 'minLengthFacet', 'max-value': 'maxValueFacet', 'maxvalue': 'maxValueFacet', 'min-value': 'minValueFacet', 'minvalue': 'minValueFacet', 'regexp': 'regexpFacet', 'element': 'elementFacet', 'export-to': 'exportTo', 'exportto': 'exportTo', 'require': 'xrequire', 'm': 'method', '::js': 'jsInclude', 'var': 'xvar', 'if': 'xif', 'else': 'xelse', 'switch': 'xswitch', 'case': 'xcase', 'for': 'xfor', 'break': 'xbreak', 'continue': 'xcontinue', 'while': 'xwhile', 'do': 'xdo', 'try': 'xtry', 'catch': 'xcatch', 'finally': 'xfinally', 'throw': 'xthrow', 'return': 'xreturn', '_': 'call', '{': 'jsObject', '[': 'jsArray', '@': 'jsPropertyOrValue', 'function': 'xfunction', 'new': 'xnew', '+': 'codeline' };
