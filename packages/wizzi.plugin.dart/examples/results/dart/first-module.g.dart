...
class Analyzer
    {/// Constructs an analyzer on the parser graph starting at [root].
        ...
        late final Set<Parser> _parsers = allParser
            (root
            )
        .toSet
            ()
        ...
        Set<Parser> allChildren
            ...
            {assert
                    (parsers.contains
                        ...
                        , 'parser is not part of the analyzer'
                    )
                ;
        ...
        ParserPath? findPathTo
            ...
            {assert
                    (parsers.contains
                        ...
                        , 'target is not part of the analyzer'
                    )
                ;
                return findPath
                    (source,
        ...
        Iterable<ParserPath> findAllPaths
            ...
            {assert
                    (parsers.contains
                        ...
                        , 'source is not part of the analyzer'
                    )
                ;
        ...
        Iterable<ParserPath> findAllPathsTo
            (Parser source, Parser target
            )
        ...
        computeFirstSets
            (parsers: _parsers, sentinel: sentinel
            )
        ;
        ...
        computeCycleSets
            (parsers: _parsers, firstSets: _firstSets
            )
        ;
        /// A unique parser used as a marker in [firstSet] and [followSet]
        /// computations.
        static final sentinel = EpsilonParser<void>
            (null
            )
        ;
    }
