/*
    ...
    package: wizzi-js@
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.plugins\packages\wizzi.plugin.dart\.wizzi-override\examples\dart_wizzify.js.ittf
...
function executeExample() {
    ...
    function wizzify(name, callback) {
        ...
        var source = path.join(__dirname, 'data', name + '.dart');
        
        createWizziFactory({}, (err, wf) => 
        
            dartwizzifier.getWizziIttf(file.read(source), {
                wf: wf, 
                syntaxOutFile: path.join(__dirname, 'data', 'output', name + '.dart.syntax')
             }, (err, ittf) => {
                ...
                file.write(path.join(__dirname, 'data', 'output', name + '.dart.ittf'), ittf)
