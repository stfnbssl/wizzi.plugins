/*
    ...
    package: wizzi-js@
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.plugins\packages\wizzi.plugin.dart\.wizzi-override\lib\artifacts\dart\module\gen\writers\block.js.ittf
...
md.loadStatementWriters = function(mainWriter) {
    mainWriter.statementsContainer.block = function(model, ctx, callback) {
        if (typeof callback === 'undefined') {
            throw new Error('Missing callback parameter in container.stm: ' + myname + '.block');
        }
