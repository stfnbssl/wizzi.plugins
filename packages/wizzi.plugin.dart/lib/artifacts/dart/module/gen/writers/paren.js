/*
    ...
    package: wizzi-js@
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.plugins\packages\wizzi.plugin.dart\.wizzi-override\lib\artifacts\dart\module\gen\writers\paren.js.ittf
...
md.loadStatementWriters = function(mainWriter) {
    mainWriter.statementsContainer.paren = function(model, ctx, callback) {
        if (typeof callback === 'undefined') {
            throw new Error('Missing callback parameter in container.stm: ' + myname + '.paren');
        }
        if (typeof callback !== 'function') {
            throw new Error('The callback parameter must be a function. In ' + myname + '.paren. Got: ' + callback);
        }
