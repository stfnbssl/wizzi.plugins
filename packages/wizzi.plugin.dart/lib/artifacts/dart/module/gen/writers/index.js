/*
    ...
    package: wizzi-js@
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.plugins\packages\wizzi.plugin.dart\.wizzi-override\lib\artifacts\dart\module\gen\writers\index.js.ittf
    utc time: Tue, 27 Feb 2024 19:59:49 GMT
*/
'use strict';

var myname = 'wizzi.plugins.dart.lib.artifacts.module.gen.writers.index';
...
;
md.statementsContainer.taggedline = function(model, ctx, callback) {
    ctx.w(model.wzName);
    md.genItems(model.statements, ctx, callback);
}
;
...
block.loadStatementWriters(md);
bracket.loadStatementWriters(md);
paren.loadStatementWriters(md);
flowControl.loadStatementWriters(md);
