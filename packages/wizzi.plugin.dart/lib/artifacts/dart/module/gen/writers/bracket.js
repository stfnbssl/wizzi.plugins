/*
    ...
    package: wizzi-js@
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.plugins\packages\wizzi.plugin.dart\.wizzi-override\lib\artifacts\dart\module\gen\writers\bracket.js.ittf
...
md.loadStatementWriters = function(mainWriter) {
    mainWriter.statementsContainer.bracket = function(model, ctx, callback) {
        if (typeof callback === 'undefined') {
            throw new Error('Missing callback parameter in container.stm: ' + myname + '.bracket');
        }
        if (typeof callback !== 'function') {
            throw new Error('The callback parameter must be a function. In ' + myname + '.bracket. Got: ' + callback);
        }
