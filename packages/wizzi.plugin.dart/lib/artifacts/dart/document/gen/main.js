/*
    ...
    package: wizzi-js@
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.plugins\packages\wizzi.plugin.dart\.wizzi-override\lib\artifacts\dart\document\gen\main.js.ittf
...
var myname = 'wizzi.plugin.dart.artifacts.dart.document.gen.main';
...
;
md.dart = function(model, ctx, callback) {
    ctx.w('<dart>');
...
function error(errorName, method, message, model, innerError) {
    return new errors.WizziPluginError(message, model, {
            errorName: errorName, 
            method: 'wizzi.plugin.dart/lib/artifacts/dart/document/gen/main.' + method, 
