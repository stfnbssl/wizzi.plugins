/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.plugins\packages\wizzi.plugin.text\.wizzi-override\lib\artifacts\text\document\gen\main.js.ittf
...
var myname = 'wizzi.plugin.text.artifacts.text.document.gen.main';
...
md.gen = function(model, ctx, callback) {
    ...
    if (model.wzElement !== 'text') {
        return callback(error('InvalidArgument', 'gen', 'Invalid model schema. Expected root element "text". Received: ' + model.wzElement, model));
    }
    try {
...
function error(errorName, method, message, model, innerError) {
    return new errors.WizziPluginError(message, model, {
            errorName: errorName, 
            method: 'wizzi.plugin.text/lib/artifacts/text/document/gen/main.' + method, 
