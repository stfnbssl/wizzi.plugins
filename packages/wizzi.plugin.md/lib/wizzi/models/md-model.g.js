...
var element = (function (mdBase) {
    ...
    element.prototype.loadChild = function(child) {
        ...
        if (name === '---') {
            return this.wzLoadToChildColl(child, _md.jsonInclude, this.elements);
        }
        if (name === 'css') {
...
// element jsonInclude
var jsonInclude = (function (element) {
    _inherits(jsonInclude, element);
...
_md.__tagElementMapping = { '@': 'attribute', '<': 'element', '+': 'plus', 'r-a': 'aRef', 'ra': 'aRef', 'r-img': 'imgRef', 'rimg': 'imgRef', '::html': 'htmlInclude', '::css': 'cssInclude', '---': 'jsonInclude', '#': 'comment' };
