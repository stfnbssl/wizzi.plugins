/*
    ...
    package: wizzi-js@
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.plugins\packages\wizzi.plugin.wfschema\.wizzi-override\examples\wfschema_document.js.ittf
...
function executeExample() {
    ...
    function executeGenerateModules(modules, callback) {
        async.mapSeries(modules, (module, callback) => {
            ...
            var outputPath = path.join(__dirname, 'results', module + '.wfschema.html');
            loadModelAndGenerateArtifact(ittfDocumentUri, {}, 'wfschema/document', (err, artifactText) => {
            
                if (err) {
                    return callback(err);
                }
                console.log('wfschema.example.executeGenerateModules.outputPath: ' + outputPath, __filename);
