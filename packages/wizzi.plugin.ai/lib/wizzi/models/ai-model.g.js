...
_md.message = message;
_md.__tagElementMapping = { 'm': 'method', '+': 'codeLine', 'openai_llm': 'OpenAI', 'directory_read': 'DirectoryRead', 'directory_rag_search': 'DirectoryRagSearch', 'file_read': 'FileRead', 'file_write': 'FileWrite', 'google_serper_search': 'GoogleSerperSearch', 'json_rag_search': 'JsonRagSearch', 'mdx_rag_search': 'MdxRagSearch', 'pdf_rag_search': 'PdfRagSearch', 'scrape_website': 'ScrapeWebsite', 'txt_rag_search': 'TxtRagSearch', 'website_rag_search': 'WebsiteRagSearch', 'custom_tool': 'CustomTool', 'pydantic_model': 'Pydantic', '@': 'property', 'p': 'llmProperty', 'tool_ref': 'toolRef', 'task_ref': 'taskRef', 'agent_ref': 'agentRef' };
