/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.plugins\packages\wizzi.plugin.raml\.wizzi-override\lib\artifacts\raml\extended\trans\main.js.ittf
*/
'use strict';
...
var myname = 'wizzi.plugin.raml.raml..trans.main';

md.trans = function(model, ctx, callback) {
    var transformedModel = {};
    if (model.wzElement !== 'raml') {
        callback(error('InvalidArgument', 'gen', 'Invalid model schema. Expected "raml". Received: ' + model.wzElement, model))
    }
...
function error(errorName, method, message, model, innerError) {
    return new errors.WizziPluginError(message, model, {
            errorName: errorName, 
            method: 'wizzi.plugin.raml/lib/artifacts/raml/extended/trans/main.' + method, 
