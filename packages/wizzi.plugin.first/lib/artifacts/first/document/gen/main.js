/*
    ...
    package: wizzi-js@
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.plugins\packages\wizzi.plugin.first\.wizzi\lib\artifacts\first\document\gen\main.js.ittf
...
var myname = 'wizzi.plugin.first.artifacts.first.document.gen.main';
...
md.gen = function(model, ctx, callback) {
    ...
    if (model.wzElement !== 'first') {
        return callback(error('InvalidArgument', 'gen', 'Invalid model schema. Expected root element "first". Received: ' + model.wzElement, model));
    }
    try {
        md.first(model, ctx, (err, notUsed) => {
...
;
md.first = function(model, ctx, callback) {
    ctx.w('<first>');
...
function error(errorName, method, message, model, innerError) {
    return new errors.WizziPluginError(message, model, {
            errorName: errorName, 
            method: 'wizzi.plugin.first/lib/artifacts/first/document/gen/main.' + method, 
