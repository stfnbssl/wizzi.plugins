/*
    ...
    package: wizzi-js@
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.plugins\packages\wizzi.plugin.first\.wizzi\root\index.js.ittf
    utc time: Fri, 07 Apr 2023 14:53:53 GMT
*/
'use strict';
...
md.name = 'wizzi.plugin.first.index';

// window(s) vars must be declared even if empty
var window_modelFactories = {
    'first': require('./lib/wizzi/models/first-factory.g')
 };
var window_artifactGenerators = {
    'first/document': require('./lib/artifacts/first/document/gen/main')
 };
var window_transformers = {
    'first/extended': require('./lib/artifacts/first/extended/trans/main')
 };
