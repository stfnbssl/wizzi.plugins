...
var pandocBase = (function () {
    function pandocBase(name, sourceLineInfo) {
        _classCallCheck(this, pandocBase);
        this.wzName = name || '';
        this.wzParent = null;
        this.wzSourceLineInfo = sourceLineInfo;
        this.wzChildren = [];
    }
    pandocBase.prototype.wzRoot = function() {
        return this.wzParent == null ? this : this.wzParent.wzRoot();
    }
    pandocBase.prototype.wzSourceFilepath = function(sourceKey) {
        var sk = sourceKey || this.wzSourceLineInfo.sourceKey;
        return this.wzRoot().loadHistory.getIttfDocumentUri(sk);
    }
    pandocBase.prototype.wzSourceErrorLines = function(node, message) {
    ...
    pandocBase.prototype.wzVerify = function() {
    }
    pandocBase.prototype.wzInitialize = function() {
    }
    pandocBase.prototype.wzInitializeAsync = function(ctx, callback) {
        callback(null);
    }
    pandocBase.prototype.wzAddChild = function(node) {
        node.wzParent = this;
        this.wzChildren.push(node);
    }
    pandocBase.prototype.wzAddChildToColl = function(node, coll) {
        node.wzParent = this;
        node.wzMoved = true;
        coll.push(node);
    }
    pandocBase.prototype.wzMoveChildToColl = function(node, coll, fromColl) {
    ...
    pandocBase.prototype.wzLoadToChildColl = function(child, type, coll) {
    ...
    pandocBase.prototype.wzCreateChildColl = function(tag, name, type, coll) {
    ...
    pandocBase.prototype.wzLoadToChildren = function(child, type) {
        var item = new type(child.v, new wzSourceLineInfo(child.r, child.c, child.u));
        item.wzTag = child.n;
        item.wzParent = this;
        if (child.wzMTreeData) {
    ...
    pandocBase.prototype.wzLoadOneToOne = function(child, type, fieldName) {
        var item = new type(child.v, new wzSourceLineInfo(child.r, child.c, child.u));
        if (child.wzMTreeData) {
            item.wzMTreeData = child.wzMTreeData;
        }
    ...
    pandocBase.prototype.wzRemove = function(fromColl) {
    ...
    pandocBase.prototype.error = function(message, node) {
        throw new _md.pandocModelException(message, node, this);
    }
    return pandocBase;
})();

_md.pandocBase = pandocBase;

// element node
var node = (function (pandocBase) {
    _inherits(node, pandocBase);
    ...
    node.prototype.loadChild = function(child) {
        ...
        if (name === '#') {
            return this.wzLoadToChildColl(child, _md.attrIdentifier, this.nodes);
        }
        if (name === '+') {
            return this.wzLoadToChildColl(child, _md.textrun, this.nodes);
        }
        if (name === '.') {
            return this.wzLoadToChildColl(child, _md.attrClass, this.nodes);
        }
        if (name === '@') {
            return this.wzLoadToChildColl(child, _md.attrKeyValue, this.nodes);
        }
        else if (name === '@') {
        ...
        if (name === 'dl') {
            return this.wzLoadToChildColl(child, _md.definitionList, this.nodes);
        }
        if (name === 'h1') {
            ...
            return this.wzLoadToChildColl(child, _md.horizontalRule, this.nodes);
        }
        if (name === 'li') {
        ...
        if (name === 'ul') {
            return this.wzLoadToChildColl(child, _md.bulletList, this.nodes);
        }
        if (name === 'div') {
            return this.wzLoadToChildColl(child, _md.div, this.nodes);
        }
        if (name === 'img') {
        ...
        if (name === 'code') {
            ...
            return this.wzLoadToChildColl(child, _md.cite, this.nodes);
        }
        if (name === 'emph') {
            return this.wzLoadToChildColl(child, _md.emphasis, this.nodes);
        }
        if (name === 'font') {
        ...
        if (name === 'plain') {
            return this.wzLoadToChildColl(child, _md.plain, this.nodes);
        }
        if (name === 'right') {
        ...
        if (name === 'figure') {
            return this.wzLoadToChildColl(child, _md.figure, this.nodes);
        }
        else if (name === 'footer') {
        ...
        if (name === 'pandoc') {
            return this.wzLoadToChildColl(child, _md.pandoc, this.nodes);
        }
        else if (name === 'postab') {
            return this.wzLoadToChildColl(child, _md.positionalTab, this.nodes);
        }
        if (name === 'quoted') {
            return this.wzLoadToChildColl(child, _md.quoted, this.nodes);
        }
        if (name === 'symbol') {
        ...
        if (name === 'rawblock') {
            return this.wzLoadToChildColl(child, _md.rawBlock, this.nodes);
        }
        if (name === 'styledef') {
        ...
        if (name === 'codeblock') {
            return this.wzLoadToChildColl(child, _md.codeBlock, this.nodes);
        }
        if (name === 'highlight') {
        ...
        else if (name === 'lineblock') {
            return this.wzLoadToChildColl(child, _md.lineBlock, this.nodes);
        }
        if (name === 'numbering') {
        ...
        if (name === 'strikeout') {
            return this.wzLoadToChildColl(child, _md.strikeout, this.nodes);
        }
        ...
        if (name === 'blockquote') {
            return this.wzLoadToChildColl(child, _md.blockQuote, this.nodes);
        }
        if (name === 'columnspan') {
    ...
    node.prototype.loadFromNode = function(node) {
        node.children.forEach((item) => {
            ...
            if (!loaded) {
                throw new _md.pandocModelException("Tag not recognized: " + item.n, item, this);
            }
        }
        )
    }
    node.prototype.wzVerify = function(ctx) {
        ...
        _md.pandocBase.prototype.wzVerify.call(this, ctx);
    }
    node.prototype.wzInitialize = function(ctx) {
        ...
        _md.pandocBase.prototype.wzInitialize.call(this, ctx);
    }
    return node;
})(pandocBase);
...
_md.node = node;
// element pandoc
var pandoc = (function (node) {
    _inherits(pandoc, node);
    function pandoc(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(pandoc.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, pandoc);
        this.wzElement = "pandoc";
    }
    pandoc.prototype.loadChild = function(child) {
    ...
    pandoc.prototype.loadFromNode = function(node) {
        node.children.forEach((item) => {
...
// element attrIdentifier
var attrIdentifier = (function (node) {
    _inherits(attrIdentifier, node);
    function attrIdentifier(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(attrIdentifier.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, attrIdentifier);
        this.wzElement = "attrIdentifier";
    }
    return attrIdentifier;
})(node);

_md.attrIdentifier = attrIdentifier;
// element attrClass
var attrClass = (function (node) {
    _inherits(attrClass, node);
    function attrClass(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(attrClass.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, attrClass);
        this.wzElement = "attrClass";
    }
    return attrClass;
})(node);

_md.attrClass = attrClass;
// element attrKeyValue
var attrKeyValue = (function (node) {
    _inherits(attrKeyValue, node);
    function attrKeyValue(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(attrKeyValue.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, attrKeyValue);
        this.wzElement = "attrKeyValue";
    }
    return attrKeyValue;
})(node);

_md.attrKeyValue = attrKeyValue;
// element meta
...
_md.meta = meta;
// element plain
var plain = (function (node) {
    _inherits(plain, node);
...
// element lineBlock
var lineBlock = (function (node) {
    _inherits(lineBlock, node);
    function lineBlock(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(lineBlock.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, lineBlock);
        this.wzElement = "lineBlock";
    }
    return lineBlock;
})(node);

_md.lineBlock = lineBlock;
// element codeBlock
var codeBlock = (function (node) {
    _inherits(codeBlock, node);
...
// element rawBlock
var rawBlock = (function (node) {
    _inherits(rawBlock, node);
    function rawBlock(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(rawBlock.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, rawBlock);
        this.wzElement = "rawBlock";
    }
    return rawBlock;
})(node);

_md.rawBlock = rawBlock;
// element blockQuote
var blockQuote = (function (node) {
    _inherits(blockQuote, node);
...
var definitionList = (function (node) {
    _inherits(definitionList, node);
    function definitionList(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(definitionList.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, definitionList);
        this.wzElement = "definitionList";
    }
    return definitionList;
})(node);

_md.definitionList = definitionList;
// element bulletList
var bulletList = (function (node) {
    _inherits(bulletList, node);
    function bulletList(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(bulletList.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, bulletList);
        this.wzElement = "bulletList";
    }
    return bulletList;
})(node);

_md.bulletList = bulletList;
// element orderedList
...
var horizontalRule = (function (node) {
    _inherits(horizontalRule, node);
    function horizontalRule(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(horizontalRule.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, horizontalRule);
        this.wzElement = "horizontalRule";
    }
    return horizontalRule;
})(node);

_md.horizontalRule = horizontalRule;
// element table
...
_md.div = div;
// element textrun
var textrun = (function (node) {
    _inherits(textrun, node);
    function textrun(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(textrun.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, textrun);
        this.wzElement = "textrun";
    }
    return textrun;
})(node);
...
var underline = (function (node) {
    ...
    underline.prototype.loadChild = function(child) {
        var ok = false, name = child.n.toLowerCase();
        if (name === 'type') {
            this.type = child.v; return true;
        }
    ...
    underline.prototype.loadFromNode = function(node) {
        node.children.forEach((item) => {
...
// element emphasis
var emphasis = (function (node) {
    _inherits(emphasis, node);
    function emphasis(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(emphasis.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, emphasis);
        this.wzElement = "emphasis";
    }
    return emphasis;
})(node);

_md.emphasis = emphasis;
// element vanish
...
_md.vanish = vanish;
// element strikeout
var strikeout = (function (node) {
    _inherits(strikeout, node);
    function strikeout(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(strikeout.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, strikeout);
        this.wzElement = "strikeout";
    }
    return strikeout;
})(node);

_md.strikeout = strikeout;
...
_md.code = code;
// element quoted
var quoted = (function (node) {
    _inherits(quoted, node);
    function quoted(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(quoted.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, quoted);
        this.wzElement = "quoted";
    }
    return quoted;
})(node);
...
_md.__tagElementMapping = { 'name': 'xname', 'type': 'xtype', 'line-rule': 'lineRule', 'linerule': 'lineRule', 'text-direction': 'textDirection', 'textdirection': 'textDirection', 'column-span': 'columnSpan', 'columnspan': 'columnSpan', 'column-widths': 'columnWidths', 'columnwidths': 'columnWidths', 'text': 'linkText', 'tab-stops-def': 'tabStopsDef', 'tabstopsdef': 'tabStopsDef', 'tab-stop-def': 'tabStopDef', 'tabstopdef': 'tabStopDef', 'tab-stops': 'tabStops', 'tabstops': 'tabStops', 'footnote': 'footnoteDef', 'footnote-ref': 'footnoteRef', 'footnoteref': 'footnoteRef', 'a': 'hyperlink', 'a#': 'internalHyperlink', 'page-ref': 'pageReference', 'pageref': 'pageReference', '#': 'attrIdentifier', '.': 'attrClass', '@': 'attrKeyValue', 'p': 'paragraph', 'line-block': 'lineBlock', 'lineblock': 'lineBlock', 'code-block': 'codeBlock', 'codeblock': 'codeBlock', 'raw-block': 'rawBlock', 'rawblock': 'rawBlock', 'block-quote': 'blockQuote', 'blockquote': 'blockQuote', 'dl': 'definitionList', 'ul': 'bulletList', 'ol': 'orderedList', 'li': 'listItem', 'hr': 'horizontalRule', 'thead': 'tableHead', 'tbody': 'tableBody', 'tr': 'tableRow', 'td': 'tableCell', '+': 'textrun', 'b': 'bold', 'i': 'italics', 'u': 'underline', 'emph': 'emphasis', 'strike-out': 'strikeout', 'double-strike': 'doubleStrike', 'doublestrike': 'doubleStrike', 'super-script': 'superScript', 'superscript': 'superScript', 'sub-script': 'subScript', 'subscript': 'subScript', 'small-caps': 'smallCaps', 'smallcaps': 'smallCaps', 'all-caps': 'allCaps', 'allcaps': 'allCaps', 'br': 'xbreak', 'styles-def': 'stylesDef', 'stylesdef': 'stylesDef', 'style-def': 'styleDef', 'styledef': 'styleDef', 'paragraph': 'paragraphDef', 'default': 'xdefault', 'paragraph-styles': 'paragraphStyles', 'paragraphstyles': 'paragraphStyles', 'character-styles': 'characterStyles', 'characterstyles': 'characterStyles', 'quick-format': 'quickFormat', 'quickformat': 'quickFormat', 'numbering-def': 'numberingDef', 'numberingdef': 'numberingDef', 'page-break': 'pageBreak', 'pagebreak': 'pageBreak', 'thematic-break': 'thematicBreak', 'thematicbreak': 'thematicBreak', 'page-break-before': 'pageBreakBefore', 'pagebreakbefore': 'pageBreakBefore', 'keep-lines': 'keepLines', 'keeplines': 'keepLines', 'keep-next': 'keepNext', 'keepnext': 'keepNext', 'format-type': 'formatType', 'formattype': 'formatType', 'page-numbers': 'pageNumbers', 'pagenumbers': 'pageNumbers', 'page-border-top': 'pageBorderTop', 'pagebordertop': 'pageBorderTop', 'page-border-right': 'pageBorderRight', 'pageborderright': 'pageBorderRight', 'page-border-bottom': 'pageBorderBottom', 'pageborderbottom': 'pageBorderBottom', 'page-border-left': 'pageBorderLeft', 'pageborderleft': 'pageBorderLeft', 'page-borders': 'pageBorders', 'pageborders': 'pageBorders', 'pos-tab': 'positionalTab', 'postab': 'positionalTab' };
// model/replaceUnknownElement( )
var pandocModelException = (function () {
    function pandocModelException(message, node, instance) {
        _classCallCheck(this, pandocModelException);
    ...
    pandocModelException.prototype.toString = function() {
        var msg = [];
        msg.push(chalk.red('Error: ' + this.message));
        msg.push(chalk.red('  name: pandocModelException'));
        if (this.node) {
    ...
    return pandocModelException;
})();

_md.pandocModelException = pandocModelException;
var pandocContext = (function () {
    function pandocContext() {
        _classCallCheck(this, pandocContext);
        this.validationErrors = [];
    }
    pandocContext.prototype.schemaIsValid = function() {
        return this.validationErrors.length == 0;
    }
    pandocContext.prototype.addError = function(message, node) {
...
_md.pandocContext = pandocContext;
...
function parseinteger(value, defaultValue, node) {
    ...
    if (!isInt(value)) {
        throw new pandocModelException('Must be an int value, got:' + value, node);
    }
