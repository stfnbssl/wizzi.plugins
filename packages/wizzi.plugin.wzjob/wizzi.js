/*
    ...
    primary source IttfDocument: C:/My/wizzi/stfnbssl/wizzi.cli/packages/wizzi.cli.meta/meta-templates/__temp/js-wizzi-plugin/wizzi.plugin.wzjob/wizzi.js.ittf
*/
'use strict';
...
function generateSchemas(schemasToGen, wzJobFolder, destPath, packageName, plugins) {
    async.mapSeries(schemasToGen, function(schemaName, callback) {
        ...
        wizzi.generateWizziModelTypes({
            ...
            wfschema: {
                name: schemaName, 
                ittfDocumentUri: path.join(wzJobFolder, 'lib', 'wizzi', 'schemas', schemaName + '.wfschema.ittf'), 
