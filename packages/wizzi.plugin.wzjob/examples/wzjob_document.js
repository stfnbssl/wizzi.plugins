/*
    ...
    package: wizzi-js@
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.plugins\packages\wizzi.plugin.wzjob\.wizzi-override\examples\wzjob_document.js.ittf
...
function executeExample() {
    ...
    function executeGenerateModules(modules, callback) {
        async.mapSeries(modules, (module, callback) => {
            ...
            var outputPath = path.join(__dirname, 'results', module + '.wzjob.html');
            loadModelAndGenerateArtifact(ittfDocumentUri, {}, 'wzjob/document', (err, artifactText) => {
            
                if (err) {
                    return callback(err);
                }
                console.log('wzjob.example.executeGenerateModules.outputPath: ' + outputPath, __filename);
