/*
    ...
    package: wizzi-js@
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.plugins\packages\wizzi.plugin.wzjob\.wizzi-override\examples\wfjob_document.js.ittf
...
function executeExample() {
    ...
    function executeGenerateModules(modules, callback) {
        async.mapSeries(modules, (module, callback) => {
            ...
            var outputPath = path.join(__dirname, 'results', module + '.wfjob.html');
            loadModelAndGenerateArtifact(ittfDocumentUri, {}, 'wfjob/document', (err, artifactText) => {
            
                if (err) {
                    return callback(err);
                }
                console.log('wfjob.example.executeGenerateModules.outputPath: ' + outputPath, __filename);
