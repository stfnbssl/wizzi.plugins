/*
    ...
    utc time: Fri, 30 Aug 2024 20:19:20 GMT
*/
...
md.name = 'wizzi.plugin.wzjob.index';

// window(s) vars must be declared even if empty
var window_modelFactories = {
    'wzjob': require('./lib/wizzi/models/wzjob-factory.g')
 };
var window_artifactGenerators = {
    'wzjob/document': require('./lib/artifacts/wzjob/document/gen/main')
 };
var window_transformers = {
    'wzjob/extended': require('./lib/artifacts/wzjob/extended/trans/main')
 };
