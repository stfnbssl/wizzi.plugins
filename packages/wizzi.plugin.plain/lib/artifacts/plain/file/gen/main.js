/*
    ...
    package: wizzi-js@
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.plugins\packages\wizzi.plugin.plain\.wizzi-override\lib\artifacts\plain\file\gen\main.js.ittf
...
var myname = 'wizzi.plugin.plain.artifacts.plain.file.gen.main';
...
md.gen = function(model, ctx, callback) {
    ...
    if (model.wzElement !== 'plain') {
        return callback(error('InvalidArgument', 'gen', 'Invalid model schema. Expected root element "plain". Received: ' + model.wzElement, model));
    }
    try {
        md.plain(model, ctx, (err, notUsed) => {
...
function error(errorName, method, message, model, innerError) {
    return new errors.WizziPluginError(message, model, {
            errorName: errorName, 
            method: 'wizzi.plugin.plain/lib/artifacts/plain/file/gen/main.' + method, 
