    ...
    function executeGenerateModules(modules, callback) {
        async.mapSeries(modules, (module, callback) => {
            ...
            loadWizziModel(ittfDocumentUri, {}, (err, wizziModel) => {
                ...
                loadModelAndGenerateArtifact(ittfDocumentUri, {}, 'css/document', (err, artifactText) => {
                
                    if (err) {
                        return callback(err);
                    }
                    console.log('css.example.executeGenerateModules.outputPath: ' + outputPath, __filename);
