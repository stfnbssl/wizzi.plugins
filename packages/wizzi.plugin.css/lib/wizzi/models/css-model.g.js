...
/*
    artifact generator: C:\My\wizzi\stfnbssl\wizzi.plugins\packages\wizzi.plugin.js\lib\artifacts\js\module\gen\main.js
    package: @wizzi/plugin.js@0.8.9
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.plugins\packages\wizzi.plugin.css\.wizzi-override\lib\wizzi\schemas\css.wzschema.ittf
...
var css = (function (cssBase) {
    ...
    css.prototype.addStatement = function(name, sourceLineInfo) {
        var retval = new _md.statement(name, sourceLineInfo);
        retval.wzParent = this;
        this.statements.push(retval);
        return retval;
    }
    css.prototype.getStatement = function(name) {
        var found = null;
    ...
    css.prototype.loadChild = function(child) {
        ...
        if (name === '::') {
            return this.wzLoadToChildColl(child, _md.pseudoElementRule, this.rules);
        }
        if (name === 'to') {
            return this.wzLoadToChildColl(child, _md.keyframeTo, this.rules);
        }
        if (name === 'from') {
            return this.wzLoadToChildColl(child, _md.keyframeFrom, this.rules);
        }
        if (name === 'layer') {
            return this.wzLoadToChildColl(child, _md.layer, this.rules);
        }
        if (name === 'media') {
        ...
        if (name === 'tailwind') {
            return this.wzLoadToChildColl(child, _md.tailwind, this.rules);
        }
        if (name === '@tailwind') {
            return this.wzLoadToChildColl(child, _md.tailwind, this.rules);
        }
...
_md.css = css;
// element statement
var statement = (function (cssBase) {
    _inherits(statement, cssBase);
...
var rule = (function (cssBase) {
    ...
    rule.prototype.loadChild = function(child) {
        ...
        if (name === '$') {
            return this.wzLoadToChildColl(child, _md.styledVar, this.properties);
        }
        if (name === '%') {
            return this.wzLoadToChildColl(child, _md.placeholder, this.rules);
        }
        ...
        if (name === 'js=>') {
            return this.wzLoadToChildColl(child, _md.jscode, this.properties);
        }
        if (name === 'left') {
        ...
        if (name === '@apply') {
            return this.wzLoadToChildColl(child, _md.apply, this.properties);
        }
        else if (name === '@layer') {
            return this.wzLoadToChildColl(child, _md.layer, this.rules);
        }
        ...
        if (name === 'stress') {
            ...
            return this.wzLoadToChildColl(child, _md.stroke, this.properties);
        }
        if (name === 'volume') {
        ...
        if (name === 'tab-size') {
            ...
            return this.wzLoadToChildColl(child, _md.text_wrap, this.properties);
        }
        ...
        if (name === 'objectfit') {
            return this.wzLoadToChildColl(child, _md.object_fit, this.properties);
        }
        ...
        else if (name === 'placeitems') {
            return this.wzLoadToChildColl(child, _md.place_items, this.properties);
        }
        ...
        if (name === 'captionside') {
            ...
            return this.wzLoadToChildColl(child, _md.color_scheme, this.properties);
        }
        ...
        if (name === 'speak-numeral') {
            ...
            return this.wzLoadToChildColl(child, _md.stroke_linecap, this.properties);
        }
        ...
        if (name === 'imagerendering') {
            return this.wzLoadToChildColl(child, _md.image_rendering, this.properties);
        }
        ...
        if (name === 'objectposition') {
            return this.wzLoadToChildColl(child, _md.object_position, this.properties);
        }
        ...
        if (name === 'scrollbar-color') {
            ...
            return this.wzLoadToChildColl(child, _md.stroke_dasharray, this.properties);
        }
        ...
        if (name === 'scrollpaddingtop') {
            ...
            return this.wzLoadToChildColl(child, _md.stroke_dashoffset, this.properties);
        }
        ...
        if (name === 'columnbreakinside') {
            return this.wzLoadToChildColl(child, _md.column_break_inside, this.properties);
        }
        else if (name === 'column-rule-color') {
            return this.wzLoadToChildColl(child, _md.column_rule_color, this.properties);
        }
        ...
        for (i=0; i<i_len; i++) {
            ...
            if (prop.wzElement === 'property') {
                ...
                if (prop.properties.length > 0) {
                    ...
                    else if (prop.styledprop) {
                        retval.push({ name: p.name(), value: null, styledprop: prop.styledprop });
                    }
                }
            }
            else {
                ...
                // loog 'verify.isNotEmpty(prop.wzName)', prop.wzTag, prop.wzName, prop.styledprop
                    ...
                    retval.push({ name: prop.wzTag, value: null, styledprop: prop.styledprop });
                }
    ...
    rule.prototype.getAscendingRuleParts = function() {
        ...
        */
        ...
        if (this.wzParent && this.wzParent.wzElement == 'layer') {
            return thisRuleParts;
        }
        
        // loog '*** parentRuleParts 3', parentRuleParts.join(',')
        else if (this.wzParent && this.wzParent.getAscendingRuleParts) {
...
// element pseudoElementRule
var pseudoElementRule = (function (rule) {
    _inherits(pseudoElementRule, rule);
    function pseudoElementRule(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(pseudoElementRule.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, pseudoElementRule);
        this.wzElement = "pseudoElementRule";
    }
    return pseudoElementRule;
})(rule);

_md.pseudoElementRule = pseudoElementRule;
// element placeholder
...
var property = (function (cssBase) {
    ...
    property.prototype.loadChild = function(child) {
        ...
        if (name === '=>') {
            this.styledprop = child.v; return true;
        }
        if (name === 'cue') {
            return this.wzLoadToChildColl(child, _md.cue, this.properties);
        }
...
// element styledVar
var styledVar = (function (property) {
    _inherits(styledVar, property);
    function styledVar(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(styledVar.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, styledVar);
        this.wzElement = "styledVar";
    }
    return styledVar;
})(property);

_md.styledVar = styledVar;
// element jscode
var jscode = (function (property) {
    _inherits(jscode, property);
    function jscode(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(jscode.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, jscode);
        this.wzElement = "jscode";
        this.js_module_items = [];
    }
    jscode.prototype.loadChild = function(child) {
    ...
    jscode.prototype.loadFromNode = function(node) {
        node.children.forEach((item) => {
...
_md.jscode = jscode;
// element apply
var apply = (function (property) {
    _inherits(apply, property);
...
var color_scheme = (function (property) {
    _inherits(color_scheme, property);
    function color_scheme(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(color_scheme.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, color_scheme);
        this.wzElement = "color_scheme";
    }
    return color_scheme;
})(property);

_md.color_scheme = color_scheme;
// element columns
...
_md.columns = columns;
// element column_break_inside
var column_break_inside = (function (property) {
    _inherits(column_break_inside, property);
    function column_break_inside(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(column_break_inside.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, column_break_inside);
        this.wzElement = "column_break_inside";
    }
    return column_break_inside;
})(property);

_md.column_break_inside = column_break_inside;
...
_md.hyphens = hyphens;
// element image_rendering
var image_rendering = (function (property) {
    _inherits(image_rendering, property);
    function image_rendering(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(image_rendering.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, image_rendering);
        this.wzElement = "image_rendering";
    }
    return image_rendering;
})(property);

_md.image_rendering = image_rendering;
// element isolation
...
// element object_fit
var object_fit = (function (property) {
    _inherits(object_fit, property);
    function object_fit(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(object_fit.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, object_fit);
        this.wzElement = "object_fit";
    }
    return object_fit;
})(property);

_md.object_fit = object_fit;
// element object_position
var object_position = (function (property) {
    _inherits(object_position, property);
    function object_position(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(object_position.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, object_position);
        this.wzElement = "object_position";
    }
    return object_position;
})(property);

_md.object_position = object_position;
// element opacity
...
_md.pitch = pitch;
// element place_items
var place_items = (function (property) {
    _inherits(place_items, property);
    function place_items(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(place_items.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, place_items);
        this.wzElement = "place_items";
    }
    return place_items;
})(property);

_md.place_items = place_items;
// element play_during
...
_md.stress = stress;
// element stroke
var stroke = (function (property) {
    _inherits(stroke, property);
    function stroke(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(stroke.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, stroke);
        this.wzElement = "stroke";
    }
    return stroke;
})(property);
...
var stroke_dasharray = (function (property) {
    _inherits(stroke_dasharray, property);
    function stroke_dasharray(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(stroke_dasharray.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, stroke_dasharray);
        this.wzElement = "stroke_dasharray";
    }
    return stroke_dasharray;
})(property);

_md.stroke_dasharray = stroke_dasharray;
// element stroke_dashoffset
var stroke_dashoffset = (function (property) {
    _inherits(stroke_dashoffset, property);
    function stroke_dashoffset(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(stroke_dashoffset.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, stroke_dashoffset);
        this.wzElement = "stroke_dashoffset";
    }
    return stroke_dashoffset;
})(property);

_md.stroke_dashoffset = stroke_dashoffset;
// element stroke_linecap
var stroke_linecap = (function (property) {
    _inherits(stroke_linecap, property);
    function stroke_linecap(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(stroke_linecap.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, stroke_linecap);
        this.wzElement = "stroke_linecap";
    }
    return stroke_linecap;
})(property);

_md.stroke_linecap = stroke_linecap;
...
// element text_wrap
var text_wrap = (function (property) {
    _inherits(text_wrap, property);
    function text_wrap(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(text_wrap.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, text_wrap);
        this.wzElement = "text_wrap";
    }
    return text_wrap;
})(property);

_md.text_wrap = text_wrap;
...
_md.media = media;
// element layer
var layer = (function (rule) {
    _inherits(layer, rule);
    function layer(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(layer.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, layer);
        this.wzElement = "layer";
    }
    return layer;
})(rule);
...
_md.layer = layer;
// element tailwind
var tailwind = (function (rule) {
    _inherits(tailwind, rule);
    function tailwind(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(tailwind.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, tailwind);
        this.wzElement = "tailwind";
    }
    return tailwind;
})(rule);

_md.tailwind = tailwind;
// element keyframes
...
// element keyframeFrom
var keyframeFrom = (function (rule) {
    _inherits(keyframeFrom, rule);
    function keyframeFrom(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(keyframeFrom.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, keyframeFrom);
        this.wzElement = "keyframeFrom";
    }
    return keyframeFrom;
})(rule);

_md.keyframeFrom = keyframeFrom;
// element keyframeTo
var keyframeTo = (function (rule) {
    _inherits(keyframeTo, rule);
    function keyframeTo(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(keyframeTo.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, keyframeTo);
        this.wzElement = "keyframeTo";
    }
    return keyframeTo;
})(rule);

_md.keyframeTo = keyframeTo;
// element fontface
