...
var element = (function (htmlBase) {
    ...
    element.prototype.loadChild = function(child) {
        ...
        else if (name === 'jspanel') {
            return this.wzLoadToChildColl(child, _md.jsPanel, this.elements);
        }
        if (name === 'picture') {
        ...
        if (name === 'bashpanel') {
            return this.wzLoadToChildColl(child, _md.bashPanel, this.elements);
        }
        if (name === 'draggable') {
...
var xfunction = (function (statement) {
    ...
    xfunction.prototype.getParams = function() {
        ...
        /*
            artifact generator: C:\My\wizzi\stfnbssl\wizzi.plugins\packages\wizzi.plugin.js\lib\artifacts\js\module\gen\main.js
            package: @wizzi/plugin.js@0.8.9
            primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.plugins\packages\wizzi.plugin.html\.wizzi-override\lib\wizzi\schemas\html.wzschema.ittf
...
// element jsPanel
var jsPanel = (function (element) {
    _inherits(jsPanel, element);
    function jsPanel(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(jsPanel.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, jsPanel);
        this.wzElement = "jsPanel";
    }
    return jsPanel;
})(element);
...
_md.jsPanel = jsPanel;
// element bashPanel
var bashPanel = (function (element) {
    _inherits(bashPanel, element);
    function bashPanel(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(bashPanel.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, bashPanel);
        this.wzElement = "bashPanel";
    }
    return bashPanel;
})(element);

_md.bashPanel = bashPanel;
// element jsInclude
