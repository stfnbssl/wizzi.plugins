/*
    ...
    package: wizzi-js@
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.plugins\packages\wizzi.plugin.html\.wizzi-override\examples\html_document.js.ittf
...
function executeExample() {
    ...
    function executeGenerateModules(modules, callback) {
        async.mapSeries(modules, (module, callback) => {
            ...
            var outputPath = path.join(__dirname, 'results', module + '.html.document.html');
            loadWizziModel(ittfDocumentUri, {}, (err, wizziModel) => {
                ...
                loadModelAndGenerateArtifact(ittfDocumentUri, {}, 'html/document', (err, artifactText) => {
                
                    if (err) {
                        return callback(err);
                    }
                    console.log('html.example.executeGenerateModules.outputPath: ' + outputPath, __filename);
