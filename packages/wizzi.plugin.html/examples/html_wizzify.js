/*
    ...
    package: wizzi-js@
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.plugins\packages\wizzi.plugin.html\.wizzi-override\examples\html_wizzify.js.ittf
...
function wizzify(name, callback) {
    ...
    htmlwizzifier.getWizziIttf(file.read(source), {
        syntaxOutFile: path.join(__dirname, 'data', 'output', name + '.html.sinthax')
     }, (err, ittf) => {
