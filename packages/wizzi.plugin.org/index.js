/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.plugins\packages\wizzi.plugin.org\.wizzi-override\root\index.js.ittf
*/
'use strict';
...
md.name = 'wizzi.plugin.org.index';

// window(s) vars must be declared even if empty
var window_modelFactories = {
    'org': require('./lib/wizzi/models/org-factory.g')
 };
var window_artifactGenerators = {
    'org/document': require('./lib/artifacts/org/document/gen/main')
 };
var window_transformers = {
    'org/extended': require('./lib/artifacts/org/extended/trans/main')
 };
