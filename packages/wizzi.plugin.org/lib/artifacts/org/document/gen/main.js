/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.plugins\packages\wizzi.plugin.org\.wizzi-override\lib\artifacts\org\document\gen\main.js.ittf
*/
'use strict';
...
var myname = 'wizzi.plugin.org.artifacts.org.document.gen.main';
...
md.gen = function(model, ctx, callback) {
    ...
    if (model.wzElement !== 'org') {
        callback(error('InvalidArgument', 'gen', 'Invalid model schema. Expected root element "org". Received: ' + model.wzElement, model))
    }
    try {
        md.org(model, ctx, (err, notUsed) => {
...
;
md.org = function(model, ctx, callback) {
    ctx.w('<org>');
...
function error(errorName, method, message, model, innerError) {
    return new errors.WizziPluginError(message, model, {
            errorName: errorName, 
            method: 'wizzi.plugin.org/lib/artifacts/org/document/gen/main.' + method, 
