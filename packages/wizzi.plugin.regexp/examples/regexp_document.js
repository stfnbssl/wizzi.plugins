/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.plugins\packages\wizzi.plugin.regexp\.wizzi-override\examples\regexp_document.js.ittf
*/
'use strict';
...
function executeExample() {
    ...
    function executeGenerateModules(modules, callback) {
        async.mapSeries(modules, (module, callback) => {
            ...
            var outputPath = path.join(__dirname, 'results', module + '.regexp.html');
            loadModelAndGenerateArtifact(ittfDocumentUri, {}, 'regexp/document', (err, artifactText) => {
            
                if (err) {
                    return callback(err);
                }
                console.log('regexp.example.executeGenerateModules.outputPath: ' + outputPath, __filename);
