/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.plugins\packages\wizzi.plugin.regexp\.wizzi-override\examples\step_2_go.js.ittf
*/
'use strict';
...
var regexp_examples_step_2 = function(step_callback) {
    ...
    wizzi.fsFactory({
        ...
        function load(callback) {
            wf.loadMTree(path.join(__dirname, 'step_2', 'css.regexp.ittf'), {}, callback)
        }
        ...
        load((err, mTreeModel) => {
            ...
            heading2( 'css.regexp.ittf - loaded mTree' );
            ...
            wizzi.fsFactory(wizziFactoryConfig, (err, wf) => {
                ...
                wf.loadModel(path.join(__dirname, 'step_2', 'css.regexp.ittf'), {}, (err, wizziModel) => {
                    ...
                    var dest = path.join(__dirname, 'step_2', 'outputs', 'css.regexp.ittf.json');
                    wf.fileService.write(dest, JSON.stringify(wizziModel.toJson(), null, 4))
                    console.log('   ', 'The json representation of css.regexp.ittf.json was saved to ' + dest);
...
regexp_examples_step_2.__name = 'Level 0 - regexp_examples_step_2';
function heading1(text) {
    console.log('');
    console.log('*'.repeat(120));
    console.log('** level 0 - step 2 - regexp_examples_step_2 - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
function heading2(text) {
    ...
    console.log('   ','-- regexp_examples_step_2 - ' + text);
    console.log('   ', '-'.repeat(100));
    console.log('');
}
...
module.exports = regexp_examples_step_2;
if (typeof require != 'undefined' && require.main === module) {
    regexp_examples_step_2();
}
