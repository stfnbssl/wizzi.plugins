/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.plugins\packages\wizzi.plugin.regexp\.wizzi-override\lib\artifacts\regexp\document\gen\main.js.ittf
*/
'use strict';
...
var myname = 'wizzi.plugin.regexp.artifacts.regexp.document.gen.main';
...
md.gen = function(model, ctx, callback) {
    ...
    if (model.wzElement !== 'regexp') {
        callback(error('InvalidArgument', 'gen', 'Invalid model schema. Expected root element "regexp". Received: ' + model.wzElement, model))
    }
    try {
        md.regexp(model, ctx, (err, notUsed) => {
...
;
md.regexp = function(model, ctx, callback) {
    ctx.w('<regexp>');
...
function error(errorName, method, message, model, innerError) {
    return new errors.WizziPluginError(message, model, {
            errorName: errorName, 
            method: 'wizzi.plugin.regexp/lib/artifacts/regexp/document/gen/main.' + method, 
