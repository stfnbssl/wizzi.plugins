...
var node = (function (logbotBase) {
    ...
    node.prototype.loadChild = function(child) {
        ...
        if (name === 'tenant') {
            return this.wzLoadToChildColl(child, _md.tenant, this.nodes);
        }
        if (name === 'ai-call') {
            return this.wzLoadToChildColl(child, _md.aiCall, this.nodes);
        }
...
*/
var tenant = (function (node) {
    _inherits(tenant, node);
    function tenant(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(tenant.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, tenant);
        this.wzElement = "tenant";
        // relation userGroup
        this.userGroups = [];
        // relation plant
        this.plants = [];
        // relation userGatewayModel
        this.userGatewayModels = [];
        // relation userDeviceModel
        this.userDeviceModels = [];
    }
    tenant.prototype.addUserGroup = function(name, sourceLineInfo) {
        var retval = new _md.userGroup(name, sourceLineInfo);
        retval.wzParent = this;
        this.userGroups.push(retval);
        return retval;
    }
    tenant.prototype.getUserGroup = function(name) {
        var found = null;
    ...
    tenant.prototype.addPlant = function(name, sourceLineInfo) {
        var retval = new _md.plant(name, sourceLineInfo);
        retval.wzParent = this;
        this.plants.push(retval);
        return retval;
    }
    tenant.prototype.getPlant = function(name) {
        var found = null;
    ...
    tenant.prototype.addUserGatewayModel = function(name, sourceLineInfo) {
        var retval = new _md.userGatewayModel(name, sourceLineInfo);
        retval.wzParent = this;
        this.userGatewayModels.push(retval);
        return retval;
    }
    tenant.prototype.getUserGatewayModel = function(name) {
        var found = null;
        this.userGatewayModels.forEach(function(item) {
            found = found || (item.wzName === name ? item : null);
        })
        return found;
    }
    tenant.prototype.addUserDeviceModel = function(name, sourceLineInfo) {
        var retval = new _md.userDeviceModel(name, sourceLineInfo);
        retval.wzParent = this;
        this.userDeviceModels.push(retval);
        return retval;
    }
    tenant.prototype.getUserDeviceModel = function(name) {
        var found = null;
        this.userDeviceModels.forEach(function(item) {
            found = found || (item.wzName === name ? item : null);
        })
        return found;
    }
    tenant.prototype.loadChild = function(child) {
        var ok = false, name = child.n.toLowerCase();
        if (name === 'plant') {
            return this.wzLoadToChildColl(child, _md.plant, this.plants);
        }
        if (name === 'user_group') {
            return this.wzLoadToChildColl(child, _md.userGroup, this.userGroups);
        }
        if (name === 'description') {
            this.description = child.v; return true;
        }
        if (name === 'user_device_model') {
            return this.wzLoadToChildColl(child, _md.userDeviceModel, this.userDeviceModels);
        }
        if (name === 'user_gateway_model') {
            return this.wzLoadToChildColl(child, _md.userGatewayModel, this.userGatewayModels);
        }
        ok = _md.node.prototype.loadChild.call(this, child);
        return ok;
    }
    tenant.prototype.loadFromNode = function(node) {
        node.children.forEach((item) => {
            var loaded = this.loadChild(item);
            if (!loaded) {
                throw new _md.logbotModelException("Tag not recognized: " + item.n, item, this);
    ...
    tenant.prototype.wzVerify = function(ctx) {
        ...
        this.userGatewayModels.forEach(item => 
            item.wzVerify(ctx)
        )
        this.userDeviceModels.forEach(item => 
            item.wzVerify(ctx)
        )
        _md.node.prototype.wzVerify.call(this, ctx);
    }
    tenant.prototype.wzInitialize = function(ctx) {
        this.userGroups.forEach(item => 
            item.wzInitialize(ctx)
        )
        this.plants.forEach(item => 
...
/**
    element userGroup
     the wzName is the `name` attribute
*/
var userGroup = (function (logbotBase) {
    _inherits(userGroup, logbotBase);
...
var plant = (function (logbotBase) {
    ...
    plant.prototype.addUserGroup = function(name, sourceLineInfo) {
        var retval = new _md.userGroup(name, sourceLineInfo);
        retval.wzParent = this;
        this.userGroups.push(retval);
        return retval;
    }
    plant.prototype.getUserGroup = function(name) {
        var found = null;
        this.userGroups.forEach(function(item) {
            found = found || (item.wzName === name ? item : null);
        })
    ...
    plant.prototype.loadChild = function(child) {
        var name = child.n.toLowerCase();
        if (name === 'owner') {
            this.owner = child.v; return true;
        }
        if (name === 'static') {
        ...
        if (name === 'model_schema') {
            this.modelSchema = child.v; return true;
        }
...
var gateway = (function (logbotBase) {
    ...
    gateway.prototype.addUserGroup = function(name, sourceLineInfo) {
        var retval = new _md.userGroup(name, sourceLineInfo);
        retval.wzParent = this;
        this.userGroups.push(retval);
        return retval;
    }
    gateway.prototype.getUserGroup = function(name) {
        var found = null;
        this.userGroups.forEach(function(item) {
            found = found || (item.wzName === name ? item : null);
        })
    ...
    gateway.prototype.loadChild = function(child) {
        ...
        if (name === 'gw_xid') {
            this.gw_xid = child.v; return true;
        }
        if (name === 'static') {
            return this.wzLoadToChildColl(child, _md.staticTag, this.staticTags);
        }
        ...
        if (name === 'settings') {
            this.settings = child.v; return true;
        }
        if (name === 'user_group') {
            return this.wzLoadToChildColl(child, _md.userGroup, this.userGroups);
        }
        if (name === 'description') {
            ...
            this.deviceModel = child.v; return true;
        }
        if (name === 'modified-id') {
            this.modifiedId = child.v; return true;
        }
        ...
        if (name === 'user_gateway_model') {
            return this.wzLoadOneToOne(child, _md.userGatewayModel, 'userGatewayModel');
        }
        return false;
    }
    ...
    gateway.prototype.wzVerify = function(ctx) {
        ...
        if (this.userGatewayModel != null) {
            this.userGatewayModel.wzVerify(ctx);
        }
        this.userGroups.forEach(item => 
            item.wzVerify(ctx)
        )
    ...
    gateway.prototype.wzInitialize = function(ctx) {
        ...
        if (this.userGatewayModel != null) {
            this.userGatewayModel.wzInitialize(ctx);
        }
        this.userGroups.forEach(item => 
            item.wzInitialize(ctx)
        )
...
var device = (function (logbotBase) {
    ...
    function device(name, sourceLineInfo) {
        ...
        // relation staticTag
        this.staticTags = [];
        // relation manufacturerDeviceModel
        this.manufacturerDeviceModel = null;
        // relation userDeviceModel
    ...
    device.prototype.addUserGroup = function(name, sourceLineInfo) {
        var retval = new _md.userGroup(name, sourceLineInfo);
        retval.wzParent = this;
        this.userGroups.push(retval);
        return retval;
    }
    device.prototype.getUserGroup = function(name) {
        var found = null;
        this.userGroups.forEach(function(item) {
            found = found || (item.wzName === name ? item : null);
        })
    ...
    device.prototype.loadChild = function(child) {
        ...
        if (name === 'device_xid') {
            this.device_xid = child.v; return true;
        }
        if (name === 'user_group') {
            return this.wzLoadToChildColl(child, _md.userGroup, this.userGroups);
        }
        ...
        if (name === 'user_device_model') {
            return this.wzLoadOneToOne(child, _md.userDeviceModel, 'userDeviceModel');
        }
        if (name === 'model_connection_schema') {
            this.modelConnectionSchema = child.v; return true;
        }
        if (name === 'manufacturer_device_model') {
            return this.wzLoadOneToOne(child, _md.manufacturerDeviceModel, 'manufacturerDeviceModel');
        }
        return false;
    }
    ...
    device.prototype.wzVerify = function(ctx) {
        ...
        if (this.manufacturerDeviceModel != null) {
            this.manufacturerDeviceModel.wzVerify(ctx);
        }
        if (this.userDeviceModel != null) {
            this.userDeviceModel.wzVerify(ctx);
        }
        this.userGroups.forEach(item => 
            item.wzVerify(ctx)
        )
    ...
    device.prototype.wzInitialize = function(ctx) {
        ...
        if (this.manufacturerDeviceModel != null) {
            this.manufacturerDeviceModel.wzInitialize(ctx);
        }
        if (this.userDeviceModel != null) {
            this.userDeviceModel.wzInitialize(ctx);
        }
        this.userGroups.forEach(item => 
            item.wzInitialize(ctx)
        )
...
var manufacturer = (function (node) {
    ...
    function manufacturer(name, sourceLineInfo) {
        ...
        // relation manufacturerDeviceModel
        this.manufacturerDeviceModels = [];
    }
    manufacturer.prototype.addManufacturerDeviceModel = function(name, sourceLineInfo) {
        var retval = new _md.manufacturerDeviceModel(name, sourceLineInfo);
        retval.wzParent = this;
        this.manufacturerDeviceModels.push(retval);
        return retval;
    }
    manufacturer.prototype.getManufacturerDeviceModel = function(name) {
        var found = null;
        this.manufacturerDeviceModels.forEach(function(item) {
            found = found || (item.wzName === name ? item : null);
        })
        return found;
    }
    manufacturer.prototype.loadChild = function(child) {
        ...
        if (name === 'manufacturer_device_model') {
            return this.wzLoadToChildColl(child, _md.manufacturerDeviceModel, this.manufacturerDeviceModels);
        }
        ok = _md.node.prototype.loadChild.call(this, child);
        return ok;
    }
    ...
    manufacturer.prototype.wzVerify = function(ctx) {
        this.manufacturerDeviceModels.forEach(item => 
            item.wzVerify(ctx)
        )
        _md.node.prototype.wzVerify.call(this, ctx);
    }
...
/**
    element manufacturerDeviceModel
     the wzName is the `name` attribute
*/
var manufacturerDeviceModel = (function (logbotBase) {
    _inherits(manufacturerDeviceModel, logbotBase);
    function manufacturerDeviceModel(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(manufacturerDeviceModel.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, manufacturerDeviceModel);
        this.wzElement = "manufacturerDeviceModel";
        // relation metric
        this.metrics = [];
    }
    manufacturerDeviceModel.prototype.addMetric = function(name, sourceLineInfo) {
        var retval = new _md.metric(name, sourceLineInfo);
        retval.wzParent = this;
        this.metrics.push(retval);
        return retval;
    }
    manufacturerDeviceModel.prototype.getMetric = function(name) {
        var found = null;
    ...
    manufacturerDeviceModel.prototype.loadChild = function(child) {
        var name = child.n.toLowerCase();
        if (name === 'owner') {
            this.owner = child.v; return true;
        }
    ...
    manufacturerDeviceModel.prototype.loadFromNode = function(node) {
        node.children.forEach((item) => {
            var loaded = this.loadChild(item);
            if (!loaded) {
                throw new _md.logbotModelException("Tag not recognized: " + item.n, item, this);
    ...
    manufacturerDeviceModel.prototype.wzVerify = function(ctx) {
        this.metrics.forEach(item => 
            item.wzVerify(ctx)
        )
        _md.logbotBase.prototype.wzVerify.call(this, ctx);
    }
    manufacturerDeviceModel.prototype.wzInitialize = function(ctx) {
        this.metrics.forEach(item => 
            item.wzInitialize(ctx)
        )
        _md.logbotBase.prototype.wzInitialize.call(this, ctx);
    }
    return manufacturerDeviceModel;
})(logbotBase);

_md.manufacturerDeviceModel = manufacturerDeviceModel;
/**
    element userDeviceModel
     the wzName is the `name` attribute
*/
var userDeviceModel = (function (logbotBase) {
    _inherits(userDeviceModel, logbotBase);
    function userDeviceModel(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(userDeviceModel.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, userDeviceModel);
        this.wzElement = "userDeviceModel";
        // relation metric
        this.metrics = [];
    }
    userDeviceModel.prototype.addMetric = function(name, sourceLineInfo) {
        var retval = new _md.metric(name, sourceLineInfo);
        retval.wzParent = this;
        this.metrics.push(retval);
        return retval;
    }
    userDeviceModel.prototype.getMetric = function(name) {
        var found = null;
        this.metrics.forEach(function(item) {
            found = found || (item.wzName === name ? item : null);
        })
    ...
    userDeviceModel.prototype.loadChild = function(child) {
        var name = child.n.toLowerCase();
        if (name === 'owner') {
            this.owner = child.v; return true;
        }
    ...
    userDeviceModel.prototype.loadFromNode = function(node) {
        node.children.forEach((item) => {
            var loaded = this.loadChild(item);
            if (!loaded) {
                throw new _md.logbotModelException("Tag not recognized: " + item.n, item, this);
    ...
    userDeviceModel.prototype.wzVerify = function(ctx) {
        this.metrics.forEach(item => 
            item.wzVerify(ctx)
        )
        _md.logbotBase.prototype.wzVerify.call(this, ctx);
    }
    userDeviceModel.prototype.wzInitialize = function(ctx) {
        this.metrics.forEach(item => 
            item.wzInitialize(ctx)
        )
        _md.logbotBase.prototype.wzInitialize.call(this, ctx);
...
_md.userDeviceModel = userDeviceModel;
/**
    element userGatewayModel
     the wzName is the `name` attribute
*/
var userGatewayModel = (function (logbotBase) {
    _inherits(userGatewayModel, logbotBase);
    function userGatewayModel(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(userGatewayModel.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, userGatewayModel);
        this.wzElement = "userGatewayModel";
        // relation dynamicTag
        this.dynamicTags = [];
        // relation script
        this.scripts = [];
    ...
    userGatewayModel.prototype.addDynamicTag = function(name, sourceLineInfo) {
        var retval = new _md.dynamicTag(name, sourceLineInfo);
        retval.wzParent = this;
        this.dynamicTags.push(retval);
        return retval;
    }
    userGatewayModel.prototype.getDynamicTag = function(name) {
        var found = null;
        this.dynamicTags.forEach(function(item) {
            found = found || (item.wzName === name ? item : null);
        })
    ...
    userGatewayModel.prototype.addScript = function(name, sourceLineInfo) {
        var retval = new _md.script(name, sourceLineInfo);
        retval.wzParent = this;
        this.scripts.push(retval);
        return retval;
    }
    userGatewayModel.prototype.getScript = function(name) {
        var found = null;
        this.scripts.forEach(function(item) {
            found = found || (item.wzName === name ? item : null);
        })
    ...
    userGatewayModel.prototype.addUserDeviceModel = function(name, sourceLineInfo) {
        var retval = new _md.userDeviceModel(name, sourceLineInfo);
        retval.wzParent = this;
        this.userDeviceModels.push(retval);
        return retval;
    }
    userGatewayModel.prototype.getUserDeviceModel = function(name) {
        var found = null;
        this.userDeviceModels.forEach(function(item) {
            found = found || (item.wzName === name ? item : null);
        })
    ...
    userGatewayModel.prototype.loadChild = function(child) {
        var name = child.n.toLowerCase();
        if (name === 'owner') {
            this.owner = child.v; return true;
        }
    ...
    userGatewayModel.prototype.loadFromNode = function(node) {
        node.children.forEach((item) => {
            var loaded = this.loadChild(item);
            if (!loaded) {
                throw new _md.logbotModelException("Tag not recognized: " + item.n, item, this);
    ...
    userGatewayModel.prototype.wzVerify = function(ctx) {
        this.dynamicTags.forEach(item => 
            item.wzVerify(ctx)
        )
        this.scripts.forEach(item => 
    ...
    userGatewayModel.prototype.wzInitialize = function(ctx) {
        this.dynamicTags.forEach(item => 
            item.wzInitialize(ctx)
        )
        this.scripts.forEach(item => 
    ...
    return userGatewayModel;
})(logbotBase);

_md.userGatewayModel = userGatewayModel;
// element jsInclude
...
_md.apply = apply;
_md.__tagElementMapping = { 'model_schema': 'modelSchema', '::js': 'jsInclude', '::json-object': 'jsonObjectInclude', '::jsonobject': 'jsonObjectInclude', '::json-array': 'jsonArrayInclude', '::jsonarray': 'jsonArrayInclude', 'ai-call': 'aiCall', 'aicall': 'aiCall', 'ai-message': 'aiMessage', 'aimessage': 'aiMessage', 'ai-result': 'aiResult', 'airesult': 'aiResult', 'user_group': 'userGroup', 'user_gateway_model': 'userGatewayModel', 'user_device_model': 'userDeviceModel', 'static': 'staticTag', 'dynamic': 'dynamicTag', 'connection_value': 'connectionValue', 'manufacturer_device_model': 'manufacturerDeviceModel', 'property': 'metricValue', 'script_ref': 'scriptRef', 'allowed_value': 'dynamicTagAllowedValue', 'regex_allowed_value': 'dynamicTagRegexAllowedValue' };
