...
var plant = (function (logbotBase) {
    ...
    plant.prototype.loadChild = function(child) {
        ...
        if (name === 'plant_id') {
            this.plant_id = child.v; return true;
        }
        if (name === 'description') {
            this.description = child.v; return true;
        }
...
var gateway = (function (logbotBase) {
    ...
    gateway.prototype.loadChild = function(child) {
        ...
        if (name === 'iot_id') {
            this.iot_id = child.v; return true;
        }
        if (name === 'script') {
...
var plc = (function (logbotBase) {
    ...
    plc.prototype.loadChild = function(child) {
        ...
        if (name === 'plc_id') {
            this.plc_id = child.v; return true;
        }
        if (name === 'protocol') {
...
/**
    element dynamicTag
     the wzName is the `tag_id` attribute
*/
var dynamicTag = (function (logbotBase) {
    ...
    dynamicTag.prototype.loadChild = function(child) {
        var name = child.n.toLowerCase();
        if (name === 'ref_plc_id') {
            this.ref_plc_id = child.v; return true;
        }
        if (name === 'description') {
            this.description = child.v; return true;
        }
...
/**
    element script
     the wzName is the `script_id` attribute
*/
