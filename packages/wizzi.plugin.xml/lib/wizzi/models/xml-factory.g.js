/*
    ...
    utc time: Thu, 25 Apr 2024 11:41:31 GMT
*/
'use strict';
...
md.createLoadModel = function(wizziObject) {
    ...
    function loadModelFromMTree(mTree, ittfDocumentUri, wizziModelRequest, options, callback) {
        // loog 'wizzi-core.wizzi.models.xml-factory.g, loaded from mTree'
    ...
    */
        ...
        return function loadModel(ittfDocumentUri, requestContext, callback) {
                ...
                loadMTree(ittfDocumentUri, requestContext, function(err, mTree) {
                    ...
                    // loog 'Loaded mTree instance for pseudo schema xml from Ittf document ' + ittfDocumentUri + ' in ' + (Date.now() - start) + ' ms'
                    ...
                    // loog 'wizzi-core.wizzi.models.xml-factory.g current __dirname', __dirname
                    // loog 'wizzi-core.wizzi.models.xml-factory.g, loaded from ittfDocumentUri: ', ittfDocumentUri, mTree
                    xmlmodel(mTree, ittfDocumentUri, wizziModelRequest, callback);
                })
            };
    }
...
function error(code, method, message, innerError) {
    ...
    return verify.error(innerError, {
        ...
        method: 'wizzi.plugin.xml.lib.wizzi.models.xml-factory.g.' + method,
        parameter: parameter,
