...
'use strict';
var fs = require('fs');
fs.readFile("./MANUAL.ast.json", "utf-8", (err, data) => {
    ...
    fs.writeFile("./MANUAL.ast.fmt.json", JSON.stringify(jsonData, null, 4), (err, data) => {
    ...
    fs.writeFile("./MANUAL.ast.schema.json", JSON.stringify(ejs(jsonData), null, 4), (err, data) => {
