...
var myname = 'wizzi.plugin.vtt.vtt.extended.trans.main';
...
md.trans = function(model, ctx, callback) {
    ...
    if (model.wzElement !== 'vtt') {
        return callback(error('InvalidArgument', 'gen', 'Invalid model schema. Expected "vtt". Received: ' + model.wzElement, model));
    }
...
function error(errorName, method, message, model, innerError) {
    return new errors.WizziPluginError(message, model, {
            errorName: errorName, 
            method: 'wizzi.plugin.vtt/lib/artifacts/vtt/extended/trans/main.' + method, 
