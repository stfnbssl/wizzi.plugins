...
var vttCue = (function (comment) {
    ...
    vttCue.DIRECTION_RL = "rl";
    
    vttCue.DIRECTION_LR = "lr";
    
    vttCue.LINEALIGN_START = "start";
    
    vttCue.LINEALIGN_CENTER = "center";
    
    vttCue.LINEALIGN_END = "end";
    
    vttCue.POSITIONALIGN_LINE_LEFT = "line-left";
    
    vttCue.POSITIONALIGN_CENTER = "center";
    
    vttCue.POSITIONALIGN_LINE_RIGHT = "line-right";
    
    vttCue.POSITIONALIGN_AUTO = "auto";
    
    vttCue.ALIGN_START = "start";
    
    vttCue.ALIGN_CENTER = "center";
    
    vttCue.ALIGN_END = "end";
    
    vttCue.ALIGN_LEFT = "left";
    
    vttCue.ALIGN_RIGHT = "right";
    
    vttCue.prototype.addCueText = function(name, sourceLineInfo) {
...
var rule = (function (comment) {
    ...
    rule.prototype.getProperties = function() {
        ...
        /*
            artifact generator: C:\My\wizzi\stfnbssl\wizzi.plugins\packages\wizzi.plugin.js\lib\artifacts\js\module\gen\main.js
            package: @wizzi/plugin.js@0.8.9
            primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.plugins\packages\wizzi.plugin.vtt\.wizzi-override\lib\wizzi\schemas\vtt.wzschema.ittf
            utc time: Mon, 06 May 2024 14:25:58 GMT
        */
        var retval = [];
...
var column_break_inside = (function (property) {
    ...
    column_break_inside.prototype.toJson = function() {
        var result = {};
        this.toJsonProperties(result);
        this.toJsonChildren(result);
        return result;
    }
    column_break_inside.prototype.toJsonProperties = function(result) {
        _md.property.prototype.toJsonProperties.call(this, result);
        if (this.__jsonProps) {
            for (var k in this.__jsonProps) {
                result[k] = this.__jsonProps[k];
    ...
    column_break_inside.prototype.toJsonChildren = function(result) {
        _md.property.prototype.toJsonChildren.call(this, result);
    }
...
var image_rendering = (function (property) {
    ...
    image_rendering.prototype.toJson = function() {
        var result = {};
        this.toJsonProperties(result);
        this.toJsonChildren(result);
        return result;
    }
    image_rendering.prototype.toJsonProperties = function(result) {
        _md.property.prototype.toJsonProperties.call(this, result);
        if (this.__jsonProps) {
            for (var k in this.__jsonProps) {
                result[k] = this.__jsonProps[k];
    ...
    image_rendering.prototype.toJsonChildren = function(result) {
        _md.property.prototype.toJsonChildren.call(this, result);
    }
...
var object_fit = (function (property) {
    ...
    object_fit.prototype.toJson = function() {
        var result = {};
        this.toJsonProperties(result);
        this.toJsonChildren(result);
        return result;
    }
    object_fit.prototype.toJsonProperties = function(result) {
        _md.property.prototype.toJsonProperties.call(this, result);
        if (this.__jsonProps) {
            for (var k in this.__jsonProps) {
                result[k] = this.__jsonProps[k];
    ...
    object_fit.prototype.toJsonChildren = function(result) {
        _md.property.prototype.toJsonChildren.call(this, result);
    }
    return object_fit;
})(property);
...
var object_position = (function (property) {
    ...
    object_position.prototype.toJson = function() {
        var result = {};
        this.toJsonProperties(result);
        this.toJsonChildren(result);
        return result;
    }
    object_position.prototype.toJsonProperties = function(result) {
        _md.property.prototype.toJsonProperties.call(this, result);
        if (this.__jsonProps) {
            for (var k in this.__jsonProps) {
                result[k] = this.__jsonProps[k];
    ...
    object_position.prototype.toJsonChildren = function(result) {
        _md.property.prototype.toJsonChildren.call(this, result);
    }
...
var stroke = (function (property) {
    ...
    stroke.prototype.toJsonProperties = function(result) {
        _md.property.prototype.toJsonProperties.call(this, result);
        if (this.__jsonProps) {
            for (var k in this.__jsonProps) {
                result[k] = this.__jsonProps[k];
    ...
    stroke.prototype.toJsonChildren = function(result) {
        _md.property.prototype.toJsonChildren.call(this, result);
    }
    return stroke;
})(property);
...
var stroke_dasharray = (function (property) {
    ...
    stroke_dasharray.prototype.toJson = function() {
        var result = {};
        this.toJsonProperties(result);
        this.toJsonChildren(result);
        return result;
    }
    stroke_dasharray.prototype.toJsonProperties = function(result) {
        _md.property.prototype.toJsonProperties.call(this, result);
        if (this.__jsonProps) {
            for (var k in this.__jsonProps) {
                result[k] = this.__jsonProps[k];
    ...
    stroke_dasharray.prototype.toJsonChildren = function(result) {
        _md.property.prototype.toJsonChildren.call(this, result);
    }
...
var stroke_dashoffset = (function (property) {
    ...
    stroke_dashoffset.prototype.toJson = function() {
        var result = {};
        this.toJsonProperties(result);
        this.toJsonChildren(result);
        return result;
    }
    stroke_dashoffset.prototype.toJsonProperties = function(result) {
        _md.property.prototype.toJsonProperties.call(this, result);
        if (this.__jsonProps) {
            for (var k in this.__jsonProps) {
                result[k] = this.__jsonProps[k];
    ...
    stroke_dashoffset.prototype.toJsonChildren = function(result) {
        _md.property.prototype.toJsonChildren.call(this, result);
    }
...
var stroke_linecap = (function (property) {
    ...
    stroke_linecap.prototype.toJson = function() {
        var result = {};
        this.toJsonProperties(result);
        this.toJsonChildren(result);
        return result;
    }
    stroke_linecap.prototype.toJsonProperties = function(result) {
        _md.property.prototype.toJsonProperties.call(this, result);
        if (this.__jsonProps) {
            for (var k in this.__jsonProps) {
                result[k] = this.__jsonProps[k];
    ...
    stroke_linecap.prototype.toJsonChildren = function(result) {
        _md.property.prototype.toJsonChildren.call(this, result);
    }
