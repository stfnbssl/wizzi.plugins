/*
    ...
    package: wizzi-js@
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.plugins\packages\wizzi.plugin.vtt\.wizzi-override\examples\vtt_document.js.ittf
...
function executeExample() {
    ...
    function executeGenerateModules(modules, callback) {
        async.mapSeries(modules, (module, callback) => {
            ...
            var outputPath = path.join(__dirname, 'results', module + '.vtt.document.html');
            loadWizziModel(ittfDocumentUri, {}, (err, wizziModel) => {
                ...
                loadModelAndGenerateArtifact(ittfDocumentUri, {}, 'vtt/document', (err, artifactText) => {
                
                    if (err) {
                        return callback(err);
                    }
                    console.log('vtt.example.executeGenerateModules.outputPath: ' + outputPath, __filename);
