/*
    ...
    package: wizzi-js@
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.plugins\packages\wizzi.plugin.geop\.wizzi-override\lib\artifacts\geop\document\gen\main.js.ittf
...
var myname = 'wizzi.plugin.geop.artifacts.geop.document.gen.main';
...
md.gen = function(model, ctx, callback) {
    ...
    if (model.wzElement !== 'geop') {
        return callback(error('InvalidArgument', 'gen', 'Invalid model schema. Expected root element "geop". Received: ' + model.wzElement, model));
    }
    try {
        md.geop(model, ctx, (err, notUsed) => {
...
;
md.geop = function(model, ctx, callback) {
    ctx.w('<geop>');
...
function error(errorName, method, message, model, innerError) {
    return new errors.WizziPluginError(message, model, {
            errorName: errorName, 
            method: 'wizzi.plugin.geop/lib/artifacts/geop/document/gen/main.' + method, 
